      ...
      794: () => {
        !(function (e, t) {
          ...
          return (
            (modules = [
              ...
              function (e, t, i) {
                ...
                function d(e, t, i) {
                  ...
                  (this.el = void 0),
                    ...
                    (this.refreshValue = !1),
                    !0 !== i &&
                      (a.isPlainObject(e) ? (t = e) : ((t = t || {}), e && (t.alias = e)),
                      (this.opts = a.extend(!0, {}, this.defaults, t)),
                ...
                function u(e, t, i) {
                  ...
                  return n
                    ? (n.alias && u(n.alias, void 0, i), a.extend(!0, i, n), a.extend(!0, i, t), !0)
                ...
                (d.prototype = {
                  ...
                  defaults: {
                    ...
                    ignorables: [
                      8, 9, 19, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45, 46, 93, 112, 113, 114, 115, 116, 117, 118, 119,
                    ...
                    return (
                      ...
                      a.each(e, function (e, i) {
                        ...
                        if (
                          (function (e, t, i, n) {
                            function s(t, a) {
                              null !== (a = void 0 !== a ? a : e.getAttribute(n + '-' + t)) &&
                                ('string' == typeof a &&
                                  (0 === t.indexOf('on')
                                    ? (a = r[a])
                                    : 'false' === a
                            ...
                            if (!0 === t.importDataAttributes) {
                              ...
                              for (o in (s('alias', c), i.alias && u(i.alias, i, t), t)) {
                                if (l)
                                  for (d in ((c = void 0), l))
                          ...
                          var s = o(n, t.noMasksCache);
                          void 0 !== s &&
                            (void 0 !== i.inputmask && ((i.inputmask.opts.autoUnmask = !0), i.inputmask.remove()),
                            (i.inputmask = new d(void 0, void 0, !0)),
                            (i.inputmask.opts = n),
                            (i.inputmask.noMasksCache = t.noMasksCache),
                            (i.inputmask.userOptions = a.extend(!0, {}, t.userOptions)),
                            (i.inputmask.isRTL = n.isRTL || n.numericInput),
                            (i.inputmask.el = i),
                            (i.inputmask.maskset = s),
                            a.data(i, '_inputmask_opts', n),
                  ...
                  option: function (e, t) {
                    return 'string' == typeof e
                      ? this.opts[e]
                      : 'object' === n(e)
                        ? (a.extend(this.userOptions, e), this.el && !0 !== t && this.mask(this.el), this)
                        : void 0;
                  },
                  ...
                  (d.extendDefaults = function (e) {
                    a.extend(!0, d.prototype.defaults, e);
                  }),
                  (d.extendDefinitions = function (e) {
                    a.extend(!0, d.prototype.definitions, e);
                  }),
                  (d.extendAliases = function (e) {
                    a.extend(!0, d.prototype.aliases, e);
                  }),
              ...
              function (e, t, i) {
                  ...
                  return e instanceof l
                    ...
                    : this instanceof l
                      ? void (
                          null != e &&
                          e !== a &&
                          ((this[0] = e.nodeName ? e : void 0 !== e[0] && e[0].nodeName ? e[0] : r.querySelector(e)),
                          void 0 !== this[0] &&
                            null !== this[0] &&
                ...
                (l.prototype = {
                  on: function (e, t) {
                    if (o(this[0]))
                      for (var i = this[0].eventRegistry, n = this[0], a = e.split(' '), r = 0; r < a.length; r++) {
                        var s = a[r].split('.');
                        (l = s[0]),
                          (c = s[1] || 'global'),
                          n.addEventListener
                            ? n.addEventListener(l, t, !1)
                            : n.attachEvent && n.attachEvent('on' + l, t),
                          (i[l] = i[l] || {}),
                          (i[l][c] = i[l][c] || []),
                          i[l][c].push(t);
                      }
                  ...
                  off: function (e, t) {
                      ...
                      if (0 < e.length)
                        if (void 0 === t)
                          for (a = 0, r = i[e][n].length; a < r; a++)
                            s.push({ ev: e, namespace: n && 0 < n.length ? n : 'global', handler: i[e][n][a] });
                        else s.push({ ev: e, namespace: n && 0 < n.length ? n : 'global', handler: t });
                      else if (0 < n.length)
                        for (var o in i)
                          for (var l in i[o])
                            if (l === n)
                              if (void 0 === t)
                                for (a = 0, r = i[o][l].length; a < r; a++)
                                  s.push({ ev: o, namespace: l, handler: i[o][l][a] });
                    ...
                    if (o(this[0])) {
                      ...
                      for (var s = e.split(' '), l = 0; l < s.length; l++)
                        for (var c = s[l].split('.'), d = r(c[0], c[1]), u = 0, p = d.length; u < p; u++)
                        ...
                        if (void 0 !== r && 'global' === u) {
                          ...
                          if (r.createEvent) {
                            try {
                              ...
                              (p = r.createEvent('CustomEvent')).initCustomEvent(d, m.bubbles, m.cancelable, m.detail);
                            }
                            e.type && l.extend(p, e), n.dispatchEvent(p);
                          } else
                            ((p = r.createEventObject()).eventType = d),
                              (p.detail = t),
                              e.type && l.extend(p, e),
                              n.fireEvent('on' + p.eventType, p);
                        } else if (void 0 !== i[d])
                          if ((((e = e.type ? e : l.Event(e)).detail = arguments.slice(1)), 'global' === u))
                            for (var h in i[d]) for (f = 0; f < i[d][h].length; f++) i[d][h][f].apply(n, arguments);
                          else for (f = 0; f < i[d][u].length; f++) i[d][u][f].apply(n, arguments);
                      }
                    return this;
                  },
                }),
                  ...
                  (l.extend = function () {
                    var e,
                      ...
                      u = !1;
                    for (
                      'boolean' == typeof o && ((u = o), (o = arguments[c] || {}), c++),
                        'object' === n(o) || l.isFunction(o) || (o = {}),
                        c === d && ((o = this), c--);
                      c < d;
                      c++
                    )
                      if (null != (e = arguments[c]))
                        for (t in e)
                          (i = o[t]),
                            o !== (a = e[t]) &&
                              (u && a && (l.isPlainObject(a) || (r = l.isArray(a)))
                                ? ((s = r ? ((r = !1), i && l.isArray(i) ? i : []) : i && l.isPlainObject(i) ? i : {}),
                                  (o[t] = l.extend(u, s, a)))
                                : void 0 !== a && (o[t] = a));
                    return o;
                  }),
                ...
                e.exports = {
                  generateMaskSet: function (e, t) {
                    function i(e, i, a) {
                      ...
                      return (
                        (s = o ? 'regex_' + a.regex : a.numericInput ? e.split('').reverse().join('') : e),
                        !1 !== a.keepStatic && (s = 'ks_' + s),
                        void 0 === Inputmask.prototype.masksCache[s] || !0 === t
                          ? ((r = {
                            ...
                            !0 !== t &&
                              ...
                              (r = n.extend(!0, {}, Inputmask.prototype.masksCache[s]))))
                          : (r = n.extend(!0, {}, Inputmask.prototype.masksCache[s])),
                        r
                      );
                    }
                    if ((n.isFunction(e.mask) && (e.mask = e.mask(e)), n.isArray(e.mask))) {
                      if (1 < e.mask.length) {
                        ...
                        return (
                          n.each(e.isRTL ? e.mask.reverse() : e.mask, function (t, i) {
                            1 < a.length && (a += e.groupmarker[1] + e.alternatormarker + e.groupmarker[0]),
                              void 0 === i.mask || n.isFunction(i.mask) ? (a += i) : (a += i.mask);
                          }),
                    ...
                    return (
                      ...
                      e.mask && void 0 !== e.mask.mask && !n.isFunction(e.mask.mask)
                  ...
                  analyseMask: function (e, t, i) {
                    ...
                    function y(e, a, r) {
                      ...
                      if (t)
                        ...
                        var o = (i.definitions ? i.definitions[a] : void 0) || Inputmask.prototype.definitions[a];
                        o && !p
                          ? e.matches.splice(r++, 0, {
                              fn: o.validator
                              ...
                              static: o.static || !1,
                              optionality: !1,
                              newBlockMarker: void 0 === s ? 'master' : s.def !== (o.definitionSymbol || a),
                              casing: o.casing,
                    ...
                    function b() {
                      if (0 < m.length) {
                        if ((y((o = m[m.length - 1]), r), o.isAlternator)) {
                          l = m.pop();
                          for (var e = 0; e < l.matches.length; e++)
                            l.matches[e].isGroup && (l.matches[e].isGroup = !1);
                          0 < m.length ? (o = m[m.length - 1]).matches.push(l) : f.matches.push(l);
                        }
                      } else y(f, r);
                    }
                    function w(e) {
                    ...
                    function k() {
                      if ((((s = m.pop()).openGroup = !1), void 0 !== s))
                        if (0 < m.length) {
                          if (((o = m[m.length - 1]).matches.push(s), o.isAlternator)) {
                            l = m.pop();
                            for (var e = 0; e < l.matches.length; e++)
                      ...
                      if (((r = a[0]), t))
                        switch (r.charAt(0)) {
                          ...
                          case '|':
                            if (0 === m.length) {
                              var x = w(f.matches);
                              (x.openGroup = !0), m.push(x), (f.matches = []), (v = !0);
                            }
                        }
                      if (p) b();
                      else
                        switch (r.charAt(0)) {
                          ...
                          case i.quantifiermarker[0]:
                            ...
                            ('*' !== C && '+' !== C) || (C = '*' === P ? 0 : 1),
                              (E.quantifier = { min: C, max: P, jit: _[1] });
                            var M = 0 < m.length ? m[m.length - 1].matches : f.matches;
                            if ((a = M.pop()).isAlternator) {
                              M.push(a), (M = a.matches);
                              var A = new g(!0),
                                L = M.pop();
                              M.push(A), (M = A.matches), (a = L);
                            }
                            a.isGroup || (a = w([a])), M.push(a), M.push(E);
                            break;
                          case i.alternatormarker:
                            if (0 < m.length) {
                              var O = (o = m[m.length - 1]).matches[o.matches.length - 1];
                              c =
                                o.openGroup && (void 0 === O.matches || (!1 === O.isGroup && !1 === O.isAlternator))
                                  ? m.pop()
                                  : S(o.matches);
                            } else c = S(f.matches);
                    ...
                    for (v && k(); 0 < m.length; ) (s = m.pop()), f.matches.push(s);
                    return (
                      0 < f.matches.length &&
                        ((function e(a) {
                          a &&
                            a.matches &&
                            n.each(a.matches, function (n, r) {
                              var s = a.matches[n + 1];
                              (void 0 === s || void 0 === s.matches || !1 === s.isQuantifier) &&
                                r &&
                                r.isGroup &&
                                ((r.isGroup = !1),
                                t || (y(r, i.groupmarker[0], 0), !0 !== r.openGroup && y(r, i.groupmarker[1]))),
                                e(r);
                            });
                        })(f),
                        h.push(f)),
              ...
              function (e, t, i) {
                i(6), i(8), i(9), i(10), (e.exports = i(1));
              },
              function (e, t, i) {
                var n = i(1);
                n.extendDefinitions({
              ...
              function (e, t, i) {
                ...
                var a = i(2),
                  r = i(3),
                  s = r.document,
                  o = (r.navigator && r.navigator.userAgent) || '',
                ...
                e.exports = function e(t, i, o) {
                  ...
                  function _(e, t, n, a, r) {
                    ...
                    var l,
                      ...
                      f = 0;
                    do {
                      if (!0 === e && i.validPositions[f])
                        (c = (d =
                          r &&
                          !0 === i.validPositions[f].match.optionality &&
                          void 0 === i.validPositions[f + 1] &&
                          (!0 === i.validPositions[f].generatedInput ||
                            (i.validPositions[f].input == o.skipOptionalPartCharacter && 0 < f))
                            ? A(f, I(f, l, f - 1))
                            : i.validPositions[f]).match),
                          (l = d.locator.slice()),
                          p.push(!0 === n ? d.input : !1 === n ? c.nativeDef : K(f, c));
                      else {
                        (c = (d = L(f, l, f - 1)).match), (l = d.locator.slice());
                        var m = !0 !== a && (!1 !== o.jitMasking ? o.jitMasking : c.jit);
                        (u =
                          (u && c.static && c.def !== o.groupSeparator && null === c.fn) ||
                          (i.validPositions[f - 1] && c.static && c.def !== o.groupSeparator && null === c.fn)) ||
                        !1 === m ||
                        void 0 === m ||
                        ('number' == typeof m && isFinite(m) && f < m)
                          ? p.push(!1 === n ? c.nativeDef : K(f, c))
                          : (u = !1);
                      }
                      f++;
                    } while (((void 0 === h || f < h) && (!0 !== c.static || '' !== c.def)) || f < t);
                    return (
                      '' === p[p.length - 1] && p.pop(),
                      (!1 === n && void 0 !== i.maskLength) || (i.maskLength = f - 1),
                      (o.greedy = s),
                      p
                    );
                  }
                  ...
                  function P(e) {
                    ...
                    return (
                      'string' == typeof t && 0 < t.length && (t = t.split(',')[0]), void 0 !== t ? t.toString() : ''
                    );
                  }
                  function M(e, t) {
                    var i = (null != e.alternation ? e.mloc[P(e)] : e.locator).join('');
                    if ('' !== i) for (; i.length < t; ) i += '0';
                    return i;
                  }
                  function A(e, t) {
                    for (var i, n, a, r = M(O((e = 0 < e ? e - 1 : 0))), s = 0; s < t.length; s++) {
                      var l = t[s];
                      i = M(l, r.length);
                      var c = Math.abs(i - r);
                      (void 0 === n ||
                        ...
                        (a && a.match.optionalQuantifier && !l.match.optionalQuantifier)) &&
                        ((n = c), (a = l));
                    }
                    return a;
                  }
                  function L(e, t, n) {
                    return i.validPositions[e] || A(e, I(e, t ? t.slice() : t, n));
                  }
                  function O(e, t) {
                    return i.validPositions[e] ? i.validPositions[e] : (t || I(e))[0];
                  }
                  function D(e, t, n) {
                    for (var a = !1, r = I(e), s = 0; s < r.length; s++) {
                      if (
                        r[s].match &&
                        (!(
                          r[s].match.nativeDef !== t.match[n.shiftPositions ? 'def' : 'nativeDef'] ||
                    ...
                    return !1 === a && void 0 !== i.jitOffset[e] && (a = D(e + i.jitOffset[e], t, n)), a;
                  }
                  function I(e, t, n) {
                    var r,
                      s = i.maskToken,
                    ...
                    function f(t, n, s, c) {
                      function m(s, c, h) {
                        function v(e, t) {
                          ...
                          return (
                            i ||
                              a.each(t.matches, function (n, a) {
                                if (
                                  (!0 === a.isQuantifier
                                    ? (i = v(e, t.matches[n - 1]))
                                    : Object.prototype.hasOwnProperty.call(a, 'matches') && (i = v(e, a)),
                                  i)
                                )
                                  return !1;
                              }),
                        ...
                        function g(e, t, n) {
                          var r, s;
                          if (
                            ((i.tests[e] || i.validPositions[e]) &&
                              a.each(i.tests[e] || [i.validPositions[e]], function (e, i) {
                                if (i.mloc[t]) return (r = i), !1;
                                var a = void 0 !== n ? n : i.alternation,
                                  o = void 0 !== i.locator[a] ? i.locator[a].toString().indexOf(t) : -1;
                                (void 0 === s || o < s) && -1 !== o && ((r = i), (s = o));
                              }),
                            r)
                          ) {
                        ...
                        function y(e, t) {
                          ...
                          return (
                            ...
                            (!(
                              !(o.regex || (e.match.fn instanceof RegExp && t.match.fn instanceof RegExp)) ||
                              !0 === e.match.static ||
                              !0 === t.match.static
                            ) &&
                              -1 !==
                        ...
                        if (l > o._maxTestPos && void 0 !== h)
                          throw (
                            'Inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. ' +
                            i.mask
                          );
                        if (l === e && void 0 === s.matches)
                          return d.push({ match: s, locator: c.reverse(), cd: p, mloc: {} }), !0;
                        if (void 0 !== s.matches) {
                          if (s.isGroup && h !== s) {
                            if ((s = m(t.matches[a.inArray(s, t.matches) + 1], c, h))) return !0;
                            ...
                            var S,
                              ...
                              _ = d.slice(),
                              T = c.length,
                              C = 0 < n.length ? n.shift() : -1;
                            if (-1 === C || 'string' == typeof C) {
                              var P,
                                M = l,
                                A = n.slice(),
                                L = [];
                              if ('string' == typeof C) L = C.split(',');
                              else for (P = 0; P < x.matches.length; P++) L.push(P.toString());
                              if (void 0 !== i.excludes[e]) {
                                for (var O = L.slice(), D = 0, I = i.excludes[e].length; D < I; D++) {
                                  var j = i.excludes[e][D].toString().split(':');
                                  c.length == j[1] && L.splice(L.indexOf(j[0]), 1);
                                }
                                0 === L.length && (delete i.excludes[e], (L = O));
                              }
                              (!0 === o.keepStatic || (isFinite(parseInt(o.keepStatic)) && M >= o.keepStatic)) &&
                                (L = L.slice(0, 1));
                              for (var F = !1, q = 0; q < L.length; q++) {
                                (P = parseInt(L[q])),
                                  (d = []),
                                  (n = ('string' == typeof C && g(l, P, T)) || A.slice()),
                                  x.matches[P] && m(x.matches[P], [P].concat(c), h) ? (s = !0) : 0 === q && (F = !0),
                                  (S = d.slice()),
                                  (l = M),
                                  (d = []);
                                for (var G = 0; G < S.length; G++) {
                                  var B = S[G],
                                    R = !1;
                                  (B.match.jit = B.match.jit || F), (B.alternation = B.alternation || T), b(B);
                                  for (var z = 0; z < E.length; z++) {
                                    var N = E[z];
                                    if (
                                      'string' != typeof C ||
                                      (void 0 !== B.alternation &&
                                        -1 !== a.inArray(B.locator[B.alternation].toString(), L))
                                    ) {
                                      if (B.match.nativeDef === N.match.nativeDef) {
                                        (R = !0), b(N, B);
                                        break;
                                      }
                                      if (y(B, N)) {
                                        b(B, N) && ((R = !0), E.splice(E.indexOf(N), 0, B));
                                        break;
                                      }
                                      if (y(N, B)) {
                                        b(N, B);
                                      ...
                                      if (
                                        ...
                                        !0 === (W = B).match.static &&
                                          !0 !== U.match.static &&
                                          U.match.fn.test(W.match.def, i, e, !1, o, !1))
                                      ) {
                                        b(B, N) && ((R = !0), E.splice(E.indexOf(N), 0, B));
                                        break;
                                      }
                              ...
                              (d = _.concat(E)), (l = e), (u = 0 < d.length), (s = 0 < E.length), (n = A.slice());
                            } else s = m(x.matches[C] || t.matches[C], [C].concat(c), h);
                            if (s) return !0;
                          } else if (s.isQuantifier && h !== t.matches[a.inArray(s, t.matches) - 1])
                            for (
                              var V = s, $ = 0 < n.length ? n.shift() : 0;
                              $ < (isNaN(V.quantifier.max) ? $ + 1 : V.quantifier.max) && l <= e;
                              $++
                            ) {
                              var H = t.matches[a.inArray(V, t.matches) - 1];
                              if ((s = m(H, [$].concat(c), H))) {
                                if (
                                  (((r = d[d.length - 1].match).optionalQuantifier = $ >= V.quantifier.min),
                                  (r.jit = ($ || 1) * H.matches.indexOf(r) >= V.quantifier.jit),
                                  r.optionalQuantifier && v(r, H))
                                ) {
                                  (u = !0), (l = e);
                                  break;
                                }
                                return r.jit && (i.jitOffset[e] = H.matches.length - H.matches.indexOf(r)), !0;
                              }
                            }
                          else if ((s = f(s, n, c, h))) return !0;
                        } else l++;
                        var W, U;
                      }
                      for (var h = 0 < n.length ? n.shift() : 0; h < t.matches.length; h++)
                        if (!0 !== t.matches[h].isQuantifier) {
                          var v = m(t.matches[h], [h].concat(s), c);
                          if (v && l === e) return v;
                          if (e < l) break;
                        }
                    }
                    if (-1 < e && (void 0 === h || e < h)) {
                            ...
                            return (
                              ...
                              0 < t.length &&
                                (void 0 === t[0].alternation || !0 === o.keepStatic
                                  ? 0 === (i = A(e, t.slice()).locator.slice()).length && (i = t[0].locator.slice())
                                      ...
                                      if ('' !== t.def)
                                        if (0 === i.length) i = t.locator.slice();
                                          ...
                                          for (var n = 0; n < i.length; n++)
                                            t.locator[n] &&
                                              -1 === i[n].toString().indexOf(t.locator[n]) &&
                                              (i[n] += ',' + t.locator[n]);
                                    })),
                              i
                            );
                      ...
                      for (var g = c.shift(); g < s.length && !((f(s[g], c, [g]) && l === e) || e < l); g++);
                    }
                    return (
                      (0 !== d.length && !u) ||
                        d.push({
                      ...
                      void 0 !== t && i.tests[e]
                        ? a.extend(!0, [], d)
                        : ((i.tests[e] = a.extend(!0, [], d)), i.tests[e])
                    );
                  }
                  function j() {
                    return (
                      void 0 === i._buffer &&
                        ((i._buffer = _(!1, 1)), void 0 === i.buffer && (i.buffer = i._buffer.slice())),
                      i._buffer
                    );
                  }
                  function F(e) {
                    return (
                      (void 0 !== i.buffer && !0 !== e) ||
                        ((i.buffer = _(!0, C(), !0)), void 0 === i._buffer && (i._buffer = i.buffer.slice())),
                      i.buffer
                    );
                  }
                  function q(e, t, n) {
                    var r,
                      ...
                      c = y ? n.slice().reverse() : n;
                    if (((o.skipOptionalPartCharacter = ''), !0 === e))
                      T(), (i.tests = {}), (e = 0), (t = n.length), (s = X({ begin: 0, end: 0 }, !1).begin);
                    else {
                      for (r = e; r < t; r++) delete i.validPositions[r];
                      s = e;
                    }
                    var d = new a.Event('keypress');
                    for (r = e; r < t; r++) {
                      (d.which = c[r].toString().charCodeAt(0)), (S = !1);
                      var u = Z.keypressEvent.call(g, d, !0, !1, !1, s);
                      !1 !== u && (s = u.forwardPosition);
                    }
                  ...
                  function G(e, t, n) {
                    switch (o.casing || t.casing) {
                      ...
                      case 'title':
                        ...
                        e =
                          0 === n || (r && r.input === String.fromCharCode(p.SPACE))
                            ? e.toUpperCase()
                            : e.toLowerCase();
                        break;
                      default:
                        if (a.isFunction(o.casing)) {
                          var s = Array.prototype.slice.call(arguments);
                          s.push(i.validPositions), (e = o.casing.apply(this, s));
                        }
                    }
                    return e;
                  }
                  function B(e, t, i) {
                    for (
                      var n, r = o.greedy ? t : t.slice(0, 1), s = !1, l = void 0 !== i ? i.split(',') : [], c = 0;
                      c < l.length;
                      c++
                    )
                      -1 !== (n = e.indexOf(l[c])) && e.splice(n, 1);
                    for (var d = 0; d < e.length; d++)
                      if (-1 !== a.inArray(e[d], r)) {
                        s = !0;
                        break;
                      }
                    return s;
                  ...
                  function R(e, t, n, r, s, l) {
                    var c,
                      ...
                      v,
                      g,
                      y = a.extend(!0, {}, i.validPositions),
                      b = a.extend(!0, {}, i.tests),
                      w = !1,
                      k = !1,
                      S = void 0 !== s ? s : C();
                    if (
                      ...
                      d = (p = O((c = 0))).alternation;
                    else
                      for (; 0 <= S; S--)
                        if ((u = i.validPositions[S]) && void 0 !== u.alternation) {
                          if (p && p.locator[u.alternation] !== u.locator[u.alternation]) break;
                          (c = S), (d = i.validPositions[c].alternation), (p = u);
                        }
                    if (void 0 !== d) {
                      (h = parseInt(c)),
                        (i.excludes[h] = i.excludes[h] || []),
                        !0 !== e && i.excludes[h].push(P(p) + ':' + p.alternation);
                      var x = [],
                        E = -1;
                      for (f = h; f < C(void 0, !0) + 1; f++)
                        -1 === E && e <= f && void 0 !== t && (x.push(t), (E = x.length - 1)),
                          (m = i.validPositions[f]) &&
                            !0 !== m.generatedInput &&
                            (void 0 === l || f < v || g <= f) &&
                            x.push(m.input),
                          delete i.validPositions[f];
                      for (
                        -1 === E && void 0 !== t && (x.push(t), (E = x.length - 1));
                        void 0 !== i.excludes[h] && i.excludes[h].length < 10;

                      ) {
                        for (
                          i.tests = {}, T(!0), w = !0, f = 0;
                          f < x.length && (w = z(w.caret || C(void 0, !0) + 1, x[f], !1, r, !0));
                          f++
                        )
                          f === E && (k = w), 1 == e && w && (k = { caretPos: f });
                        if (w) break;
                        if (
                          (T(),
                          (p = O(h)),
                          (i.validPositions = a.extend(!0, {}, y)),
                          (i.tests = a.extend(!0, {}, b)),
                          !i.excludes[h])
                        ) {
                          k = R(e, t, n, r, h - 1, l);
                          break;
                        ...
                        var _ = P(p);
                        if (-1 !== i.excludes[h].indexOf(_ + ':' + p.alternation)) {
                          k = R(e, t, n, r, h - 1, l);
                          break;
                        }
                        for (i.excludes[h].push(_ + ':' + p.alternation), f = h; f < C(void 0, !0) + 1; f++)
                          delete i.validPositions[f];
                      }
                    }
                    return (k && !1 === o.keepStatic) || delete i.excludes[h], k;
                  }
                  function z(e, t, n, r, s, l) {
                    function c(e) {
                      return y
                    ...
                    function u(e) {
                      if (void 0 !== e) {
                        if (
                          (void 0 !== e.remove &&
                            (a.isArray(e.remove) || (e.remove = [e.remove]),
                            a.each(
                            ...
                            (e.remove = void 0)),
                          void 0 !== e.insert &&
                            (a.isArray(e.insert) || (e.insert = [e.insert]),
                            a.each(
                          ...
                          q(!0 === t ? t : t.start, t.end, e.buffer), (e.refreshFromBuffer = void 0);
                        }
                        void 0 !== e.rewritePosition && ((d = e.rewritePosition), (e = !0));
                      }
                      return e;
                    }
                    function p(t, n, s) {
                        ...
                        a.each(I(t), function (d, p) {
                          ...
                          if (
                            ...
                            !1 !==
                              (l =
                                null != f.fn
                                  ? f.fn.test(n, i, t, s, o, c(e))
                                  : (n === f.def || n === o.skipOptionalPartCharacter) &&
                                    '' !== f.def && { c: K(t, f, !0) || f.def, pos: t }))
                          ) {
                            var m = void 0 !== l.c ? l.c : n,
                              h = t;
                            return (
                              (m = m === o.skipOptionalPartCharacter && !0 === f.static ? K(t, f, !0) || f.def : m),
                              !0 !== (l = u(l)) && void 0 !== l.pos && l.pos !== t && (h = l.pos),
                              (!0 !== l && void 0 === l.pos && void 0 === l.c) ||
                                (!1 === V(e, a.extend({}, p, { input: G(m, f, h) }), r, h) && (l = !1)),
                              !1
                            );
                          }
                        }),
                    ...
                    void 0 !== e.begin && (d = y ? e.end : e.begin);
                    var f = !0,
                      m = a.extend(!0, {}, i.validPositions);
                    if (!1 === o.keepStatic && void 0 !== i.excludes[d] && !0 !== s && !0 !== r)
                      for (var v = d; v < (y ? e.begin : e.end); v++)
                        void 0 !== i.excludes[v] && ((i.excludes[v] = void 0), delete i.tests[v]);
                    if (
                      (a.isFunction(o.preValidation) &&
                        !0 !== r &&
                        !0 !== l &&
                        (f = u((f = o.preValidation.call(g, F(), d, t, c(e), o, i, e, n || s)))),
                      !0 === f)
                    ) {
                      if (void 0 === h || d < h) {
                        if (((f = p(d, t, n)), (!n || !0 === r) && !1 === f && !0 !== l)) {
                          var b = i.validPositions[d];
                          if (!b || !0 !== b.match.static || (b.match.def !== t && t !== o.skipOptionalPartCharacter)) {
                            if (o.insertMode || void 0 === i.validPositions[H(d)] || e.end > d) {
                              var w = !1;
                              if (
                                (i.jitOffset[d] &&
                                  void 0 === i.validPositions[H(d)] &&
                                  !1 !== (f = z(d + i.jitOffset[d], t, !0)) &&
                                  (!0 !== s && (f.caret = d), (w = !0)),
                                e.end > d && (i.validPositions[d] = void 0),
                                !w && !$(d, o.keepStatic))
                              )
                                for (var k = d + 1, S = H(d); k <= S; k++)
                                  if (!1 !== (f = p(k, t, n))) {
                                    (f = N(d, void 0 !== f.pos ? f.pos : k) || f), (d = k);
                                    break;
                                  }
                            }
                          } else f = { caret: H(d) };
                      ...
                      !1 !== f || !o.keepStatic || (!se(F()) && 0 !== d) || n || !0 === s
                        ? c(e) && i.tests[d] && 1 < i.tests[d].length && o.keepStatic && !n && !0 !== s && (f = R(!0))
                        : (f = R(d, t, n, r, void 0, e)),
                        !0 === f && (f = { pos: d });
                    }
                    if (a.isFunction(o.postValidation) && !0 !== r && !0 !== l) {
                      var x = o.postValidation.call(
                        g,
                        F(!0),
                    ...
                    return (
                      f && void 0 === f.pos && (f.pos = d),
                      !1 === f || !0 === l ? (T(!0), (i.validPositions = a.extend(!0, {}, m))) : N(void 0, d, !0),
                      u(f)
                    );
                  }
                  function N(e, t, n) {
                    ...
                    for (var r = e; r < t; r++)
                      if (void 0 === i.validPositions[r] && !$(r, !0) && (0 == r ? O(r) : i.validPositions[r - 1])) {
                        var s = I(r).slice();
                        ...
                        if (
                          ...
                          (!0 !== l.match.jit ||
                            ('master' === l.match.newBlockMarker &&
                              (o = i.validPositions[r + 1]) &&
                              !0 === o.match.optionalQuantifier)) &&
                          (((l = a.extend({}, l, { input: K(r, l.match, !0) || l.match.def })).generatedInput = !0),
                          V(r, l, !0),
                          !0 !== n)
                        ) {
                          var c = i.validPositions[t].input;
                          return (i.validPositions[t] = void 0), z(t, c, !0, !0);
                        }
                      }
                  }
                  function V(e, t, n, r) {
                    ...
                    if (
                      (e.begin > e.end && ((c = e.end), (d = e.begin)),
                      (r = void 0 !== r ? r : c),
                      c !== d || (o.insertMode && void 0 !== i.validPositions[r] && void 0 === n) || void 0 === t)
                    ) {
                      var u,
                        p = a.extend(!0, {}, i.validPositions),
                        f = C(void 0, !0);
                      for (i.p = c, u = f; c <= u; u--)
                        delete i.validPositions[u], void 0 === t && delete i.tests[u + 1];
                      var m,
                        h,
                        v = !0,
                        g = r,
                        y = g;
                      for (
                        u = g, t && ((i.validPositions[r] = a.extend(!0, {}, t)), y++, g++, c < d && u++);
                        u <= f;
                        u++
                      ) {
                        if (
                          void 0 !== (m = p[u]) &&
                          !0 !== m.generatedInput &&
                          (d <= u || (c <= u && s(u, p, { begin: c, end: d })))
                        ) {
                          for (; '' !== O(y).match.def; ) {
                            if (!1 !== (h = D(y, m, o)) || '+' === m.match.def) {
                              '+' === m.match.def && F(!0);
                              var b = z(y, m.input, '+' !== m.match.def, '+' !== m.match.def);
                              if (((v = !1 !== b), (g = (b.pos || y) + 1), !v && h)) break;
                            } else v = !1;
                            if (v) {
                              void 0 === t && m.match.static && u === e.begin && l++;
                              break;
                            }
                            if (!v && y > i.maskLength) break;
                            y++;
                          }
                      ...
                      if (!v) return (i.validPositions = a.extend(!0, {}, p)), T(!0), !1;
                    } else t && O(r).match.cd === t.match.cd && (i.validPositions[r] = a.extend(!0, {}, t));
                    return T(!0), l;
                  }
                  function $(e, t, n) {
                    var a = L(e).match;
                    if (('' === a.def && (a = O(e).match), !0 !== a.static)) return a.fn;
                    if (!0 === n && void 0 !== i.validPositions[e] && !0 !== i.validPositions[e].generatedInput)
                      return !0;
                    if (!0 !== t && -1 < e) {
                      if (n) {
                        var r = I(e);
                  ...
                  function H(e, t, i) {
                    ...
                    for (
                      var n = e + 1;
                      '' !== O(n).match.def &&
                      ((!0 === t && (!0 !== O(n).match.newBlockMarker || !$(n, void 0, !0))) ||
                        (!0 !== t && !$(n, void 0, i)));
                  ...
                  function W(e, t) {
                    ...
                    for (
                      ;
                      0 < --n &&
                      ((!0 === t && !0 !== O(n).match.newBlockMarker) ||
                        (!0 !== t &&
                          !$(n, void 0, !0) &&
                          ((i = I(n)).length < 2 || (2 === i.length && '' === i[1].match.def))));

                    );
                    return n;
                  }
                  function U(e, t, i, n, r) {
                    if (n && a.isFunction(o.onBeforeWrite)) {
                      var s = o.onBeforeWrite.call(v, n, t, i, o);
                      if (s) {
                        if (s.refreshFromBuffer) {
                          var l = s.refreshFromBuffer;
                          q(!0 === l ? l : l.start, l.end, s.buffer || t), (t = F(!0));
                        }
                    ...
                    if (
                      ...
                      void 0 === i ||
                        ...
                        ne(
                          ...
                          void 0,
                          void 0,
                          void 0 !== n && 'keydown' === n.type && (n.keyCode === p.DELETE || n.keyCode === p.BACKSPACE)
                        ),
                      !0 === r)
                    ) {
                      var c = a(e),
                      ...
                      (w = !0),
                        c.trigger('input'),
                        setTimeout(function () {
                          d === j().join('') ? c.trigger('cleared') : !0 === se(t) && c.trigger('complete');
                        }, 0);
                    }
                  }
                  function K(e, t, n) {
                    if (void 0 !== (t = t || O(e).match).placeholder || !0 === n)
                      return a.isFunction(t.placeholder) ? t.placeholder(o) : t.placeholder;
                      ...
                      if (s.length > 1 + ('' === s[s.length - 1].match.def ? 1 : 0))
                        for (var c = 0; c < s.length; c++)
                          if (
                            ...
                            (!0 === s[c].match.static ||
                              void 0 === r ||
                              !1 !== s[c].match.fn.test(r.match.def, i, e, !0, o)) &&
                            (l.push(s[c]),
                            !0 === s[c].match.static && (r = s[c]),
                      ...
                      switch (o.positionCaretOnClick) {
                        ...
                        case 'radixFocus':
                          if (
                            (function (e) {
                              if ('' !== o.radixPoint && 0 !== o.digits) {
                                ...
                                if (void 0 === t[e] || t[e].input === K(e)) {
                                  if (e < H(-1)) return !0;
                                  var n = a.inArray(o.radixPoint, F());
                                  if (-1 !== n) {
                                    for (var r in t) if (t[r] && n < r && t[r].input !== K(r)) return !1;
                                    return !0;
                                  }
                                }
                              }
                            ...
                            var n = F().join('').indexOf(o.radixPoint);
                            e.end = e.begin = o.numericInput ? H(n) : n;
                            break;
                          }
                        default:
                          var r = e.begin,
                            s = C(r, !0),
                            l = H(-1 !== s || $(0) ? s : 0);
                          if (r < l) e.end = e.begin = $(r, !0) || $(r - 1, !0) ? r : H(r);
                          else {
                            var c = i.validPositions[s],
                              d = L(l, c ? c.match.locator : void 0, c),
                              u = K(l, d.match);
                            if (
                              ('' !== u &&
                                F()[l] !== u &&
                      ...
                      on: function (e, t, i) {
                        var n = function (t) {
                          ...
                          if (void 0 === r.inputmask && 'FORM' !== this.nodeName) {
                            var s = a.data(r, '_inputmask_opts');
                            s ? new Inputmask(s).mask(r) : J.off(r);
                          } else {
                            if (
                              'setvalue' === t.type ||
                              'FORM' === this.nodeName ||
                              ...
                              switch (t.type) {
                                case 'input':
                                  if (!0 === w || (t.inputType && 'insertCompositionText' === t.inputType))
                                    return (w = !1), t.preventDefault();
                                  break;
                                case 'keydown':
                                  (b = !1), (w = !1);
                                  break;
                        ...
                        (e.inputmask.events[t] = e.inputmask.events[t] || []),
                          ...
                          -1 !== a.inArray(t, ['submit', 'reset'])
                            ? null !== e.form && a(e.form).on(t, n)
                            : a(e).on(t, n);
                      },
                      off: function (e, t) {
                        var i;
                        e.inputmask &&
                          e.inputmask.events &&
                          (t ? ((i = [])[t] = e.inputmask.events[t]) : (i = e.inputmask.events),
                          a.each(i, function (t, i) {
                            for (; 0 < i.length; ) {
                              var n = i.pop();
                              -1 !== a.inArray(t, ['submit', 'reset'])
                                ? null !== e.form && a(e.form).off(t, n)
                                : a(e).off(t, n);
                            }
                    ...
                    Z = {
                      keydownEvent: function (e) {
                        var t = this,
                          ...
                          r = e.keyCode,
                          s = ne(t),
                          l = o.onKeyDown.call(this, e, F(), s, o);
                        if (void 0 !== l) return l;
                        if (
                          r === p.BACKSPACE ||
                          r === p.DELETE ||
                          (u && r === p.BACKSPACE_SAFARI) ||
                          (e.ctrlKey && r === p.X && !('oncut' in t))
                        )
                          e.preventDefault(),
                            oe(0, r, s),
                            U(t, F(!0), i.p, e, t.inputmask._valueGet() !== F().join(''));
                        else if (r === p.END || r === p.PAGE_DOWN) {
                          e.preventDefault();
                          var c = H(C());
                          ne(t, e.shiftKey ? s.begin : c, c, !0);
                        } else
                          (r === p.HOME && !e.shiftKey) || r === p.PAGE_UP
                            ? (e.preventDefault(), ne(t, 0, e.shiftKey ? s.begin : 0, !0))
                            : ((o.undoOnEscape && r === p.ESCAPE) || (90 === r && e.ctrlKey)) && !0 !== e.altKey
                              ? (ee(t, !0, !1, f.split('')), n.trigger('click'))
                              : !0 === o.tabThrough && r === p.TAB
                                ? (!0 === e.shiftKey
                                    ? (!0 === O(s.begin).match.static && (s.begin = H(s.begin)),
                                      (s.end = W(s.begin, !0)),
                                      (s.begin = W(s.end, !0)))
                                    : ((s.begin = H(s.begin, !0)),
                                      (s.end = H(s.begin, !0)),
                                      s.end < i.maskLength && s.end--),
                                  s.begin < i.maskLength && (e.preventDefault(), ne(t, s.begin, s.end)))
                                : e.shiftKey ||
                                  (o.insertModeVisual &&
                                    !1 === o.insertMode &&
                                    (r === p.RIGHT
                                      ...
                                      : r === p.LEFT &&
                                        setTimeout(function () {
                                          var e = ie(t.inputmask.caretPos.begin);
                                          ie(t.inputmask.caretPos.end),
                                            ne(t, y ? e + (e === i.maskLength ? 0 : 1) : e - (0 === e ? 0 : 1));
                                        }, 0)));
                        S = -1 !== a.inArray(r, o.ignorables);
                      },
                      keypressEvent: function (e, t, n, r, s) {
                        var l = this,
                          c = a(l),
                          d = e.which || e.charCode || e.keyCode;
                        if (!(!0 === t || (e.ctrlKey && e.altKey)) && (e.ctrlKey || e.metaKey || S))
                          return (
                            d === p.ENTER &&
                              f !== F().join('') &&
                              ((f = F().join('')),
                        ...
                        if (d) {
                          (44 !== d && 46 !== d) ||
                            3 !== e.location ||
                            '' === o.radixPoint ||
                            (d = o.radixPoint.charCodeAt(0));
                          var u,
                            m = t ? { begin: s, end: s } : ne(l),
                          ...
                          if (
                            (!1 !== v &&
                              (T(!0),
                              (u = void 0 !== v.caret ? v.caret : H(v.pos.begin ? v.pos.begin : v.pos)),
                              (i.p = u)),
                            (u = o.numericInput && void 0 === v.caret ? W(u) : u),
                            !1 !== n &&
                              (setTimeout(function () {
                                o.onKeyValidation.call(l, d, v);
                              }, 0),
                              i.writeOutBuffer && !1 !== v))
                          ) {
                            var g = F();
                            U(l, g, u, e, !0 !== t);
                          }
                          if ((e.preventDefault(), t)) return !1 !== v && (v.forwardPosition = u), v;
                        }
                      },
                      pasteEvent: function (e) {
                        var t,
                          ...
                          n = ne(this);
                        y && ((t = n.end), (n.end = n.begin), (n.begin = t));
                        var s = i.substr(0, n.begin),
                          l = i.substr(n.end, i.length);
                        if (
                          (s == (y ? j().slice().reverse() : j()).slice(0, n.begin).join('') && (s = ''),
                          l == (y ? j().slice().reverse() : j()).slice(n.end).join('') && (l = ''),
                          r.clipboardData && r.clipboardData.getData)
                        )
                          i = s + r.clipboardData.getData('Text') + l;
                        else {
                          if (!e.clipboardData || !e.clipboardData.getData) return !0;
                          i = s + e.clipboardData.getData('text/plain') + l;
                        }
                        var c = i;
                        if (a.isFunction(o.onBeforePaste)) {
                          if (!1 === (c = o.onBeforePaste.call(v, i, o))) return e.preventDefault();
                          c = c || i;
                        }
                        return (
                          ee(this, !1, !1, c.toString().split('')),
                          U(this, F(), H(C()), e, f !== F().join('')),
                          e.preventDefault()
                        );
                      },
                      inputFallBackEvent: function (e) {
                        var t = this,
                          ...
                          n = (y ? F().slice().reverse() : F()).join(''),
                          r = ne(t, void 0, void 0, !0);
                        if (n !== i) {
                          i = (function (e, t, i) {
                            if (d) {
                              var n = t.replace(F().join(''), '');
                              if (1 === n.length) {
                                var a = t.split('');
                          ...
                          var l = (function (e, t, i) {
                            for (
                              var n,
                                a,
                                r,
                                s = e.substr(0, i.begin).split(''),
                                l = e.substr(i.begin).split(''),
                                c = t.substr(0, i.begin).split(''),
                                d = t.substr(i.begin).split(''),
                                u = s.length >= c.length ? s.length : c.length,
                                p = l.length >= d.length ? l.length : d.length,
                                f = '',
                                m = [];
                              s.length < u;
                              ...
                              s.push('~');
                            for (; c.length < u; ) c.push('~');
                            for (; l.length < p; ) l.unshift('~');
                            for (; d.length < p; ) d.unshift('~');
                            var h = s.concat(l),
                              v = c.concat(d);
                            for (a = 0, n = h.length; a < n; a++)
                              switch (((r = K(ie(a))), f)) {
                                case 'insertText':
                                  v[a - 1] === h[a] && i.begin == h.length - 1 && m.push(h[a]), (a = n);
                                  break;
                                ...
                                default:
                                  h[a] !== v[a] &&
                                    (('~' !== h[a + 1] && h[a + 1] !== r && void 0 !== h[a + 1]) ||
                                    ((v[a] !== r || '~' !== v[a + 1]) && '~' !== v[a])
                                      ? '~' === v[a + 1] && v[a] === h[a + 1]
                                        ? ((f = 'insertText'), m.push(h[a]), i.begin--, i.end--)
                                        : h[a] !== r &&
                                            '~' !== h[a] &&
                                            ('~' === h[a + 1] || (v[a] !== h[a] && v[a + 1] === h[a + 1]))
                                          ? ((f = 'insertReplacementText'), m.push(h[a]), i.begin--)
                                          : '~' === h[a]
                                            ? ((f = 'deleteContentBackward'),
                                              (!$(ie(a), !0) && v[a] !== o.radixPoint) || i.end++)
                                            : (a = n)
                                      : ((f = 'insertText'), m.push(h[a]), i.begin--, i.end--));
                              }
                            return { action: f, data: m, caret: i };
                          })(i, n, r);
                          switch (
                            ((t.inputmask.shadowRoot || s).activeElement !== t && t.focus(),
                            U(t, F()),
                            ne(t, r.begin, r.end, !0),
                            l.action)
                          ) {
                            case 'insertText':
                            case 'insertReplacementText':
                              a.each(l.data, function (e, i) {
                                var n = new a.Event('keypress');
                                (n.which = i.charCodeAt(0)), (S = !1), Z.keypressEvent.call(t, n);
                              }),
                                setTimeout(function () {
                                  m.trigger('keyup');
                                }, 0);
                      ...
                      setValueEvent: function (e, t, i) {
                        ...
                        void 0 === n && (n = this.inputmask._valueGet(!0)),
                          ...
                          ((e.detail && void 0 !== e.detail[1]) || void 0 !== i) &&
                            ne(this, e.detail ? e.detail[1] : i);
                      },
                      focusEvent: function (e) {
                        var t = this.inputmask._valueGet();
                        o.showMaskOnFocus && t !== F().join('') && U(this, F(), H(C())),
                      ...
                      cutEvent: function (e) {
                        var t = ne(this),
                          ...
                          a = y ? F().slice(t.end, t.begin) : F().slice(t.begin, t.end);
                        n.setData('text', y ? a.reverse().join('') : a.join('')),
                          s.execCommand && s.execCommand('copy'),
                          oe(0, p.DELETE, t),
                          U(this, F(), i.p, e, f !== F().join(''));
                      },
                      blurEvent: function (e) {
                        ...
                        if (this.inputmask) {
                          ...
                          var i = this.inputmask._valueGet(),
                            n = F().slice();
                          '' !== i &&
                            (o.clearMaskOnLostFocus && (-1 === C() && i === j().join('') ? (n = []) : re(n)),
                            !1 === se(n) &&
                              (setTimeout(function () {
                                t.trigger('incomplete');
                              }, 0),
                              o.clearIncomplete && (T(), (n = o.clearMaskOnLostFocus ? [] : j().slice()))),
                            U(this, n, void 0, e)),
                            f !== F().join('') && ((f = F().join('')), t.trigger('change'));
                        }
                      },
                      mouseenterEvent: function () {
                        (x = !0),
                          (this.inputmask.shadowRoot || s).activeElement !== this &&
                            ...
                            o.showMaskOnHover && Y(this, (y ? j().slice().reverse() : j()).join('')));
                      },
                      submitEvent: function () {
                        f !== F().join('') && m.trigger('change'),
                          o.clearMaskOnLostFocus &&
                            ...
                            g.inputmask._valueGet() === j().join('') &&
                            g.inputmask._valueSet(''),
                          o.clearIncomplete && !1 === se(F()) && g.inputmask._valueSet(''),
                  ...
                  function ee(e, t, n, r, s) {
                    ...
                    T(),
                      (i.tests = {}),
                      (u = o.radixPoint ? X({ begin: 0, end: 0 }).begin : 0),
                      (i.p = u),
                      (l.caretPos = { begin: u });
                    var f = [],
                      m = l.caretPos;
                    if (
                      (a.each(c, function (t, r) {
                        if (void 0 !== r)
                          if (
                            void 0 === i.validPositions[t] &&
                            c[t] === K(t) &&
                            $(t, !0) &&
                            !1 === z(t, c[t], !0, void 0, void 0, !0)
                          )
                            i.p++;
                          else {
                            var s = new a.Event('_checkval');
                            (s.which = r.toString().charCodeAt(0)), (d += r);
                            var o = C(void 0, !0);
                            !(function (e, t) {
                              for (
                                var i = _(!0, 0).slice(e, H(e)).join('').replace(/'/g, ''), n = i.indexOf(t);
                                0 < n && ' ' === i[n - 1];
                              ...
                              var a =
                                0 === n &&
                                !$(e) &&
                                (O(e).match.nativeDef === t.charAt(0) ||
                                  (!0 === O(e).match.static && O(e).match.nativeDef === "'" + t.charAt(0)) ||
                                  (' ' === O(e).match.nativeDef &&
                                    (O(e + 1).match.nativeDef === t.charAt(0) ||
                                      (!0 === O(e + 1).match.static &&
                                        O(e + 1).match.nativeDef === "'" + t.charAt(0)))));
                              return !a && 0 < n && (l.caretPos = { begin: H(n) }), a;
                            })(u, d)
                              ? (p = Z.keypressEvent.call(e, s, !0, !1, n, l.caretPos.begin)) &&
                                ((u = l.caretPos.begin + 1), (d = ''))
                              : (p = Z.keypressEvent.call(e, s, !0, !1, n, o + 1)),
                              p
                                ? (void 0 !== p.pos &&
                                    i.validPositions[p.pos] &&
                                    !0 === i.validPositions[p.pos].match.static &&
                                    void 0 === i.validPositions[p.pos].alternation &&
                                    (f.push(p.pos), y || (p.forwardPosition = p.pos + 1)),
                                  U(void 0, F(), p.forwardPosition, s, !1),
                      ...
                      var h,
                        v,
                        g = H(-1, void 0, !1);
                      if ((!se(F()) && f.length <= g) || (se(F()) && 0 < f.length && f.length !== g && 0 === f[0]))
                        for (var b = g; void 0 !== (h = f.shift()); ) {
                          var w = new a.Event('_checkval');
                          if (
                            (((v = i.validPositions[h]).generatedInput = !0),
                            (w.which = v.input.charCodeAt(0)),
                            (p = Z.keypressEvent.call(e, w, !0, !1, n, b)) &&
                              void 0 !== p.pos &&
                              p.pos !== h &&
                              i.validPositions[p.pos] &&
                              !0 === i.validPositions[p.pos].match.static)
                      ...
                      else for (; (h = f.pop()); ) (v = i.validPositions[h]) && (v.generatedInput = !0);
                    }
                    if (t)
                      for (var k in (U(
                        e,
                        ...
                        s || new a.Event('checkval'),
                        s && 'input' === s.type
                      ),
                      i.validPositions))
                        !0 !== i.validPositions[k].match.generated && delete i.validPositions[k].generatedInput;
                  }
                  function te(e) {
                    if (e) {
                    ...
                    if (a.isFunction(o.onUnMask)) {
                      var l = (y ? F().slice().reverse() : F()).join('');
                      s = o.onUnMask.call(v, l, s, o);
                    }
                    return s;
                  }
                  function ie(e) {
                    ...
                    if (void 0 === t)
                      return (
                        'selectionStart' in e && 'selectionEnd' in e
                          ...
                          : r.getSelection
                            ? ((c = r.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== e &&
                                c.commonAncestorContainer !== e) ||
                              ((t = c.startOffset), (i = c.endOffset))
                            : s.selection &&
                              ...
                              (i =
                                (t =
                                  ...
                                  (c = s.selection.createRange())
                                    .duplicate()
                                    .moveStart('character', -e.inputmask._valueGet().length)) + c.text.length),
                        { begin: n ? t : ie(t), end: n ? i : ie(i) }
                      );
                    if (
                      (a.isArray(t) && ((i = y ? t[0] : t[1]), (t = y ? t[1] : t[0])),
                      void 0 !== t.begin && ((i = y ? t.begin : t.end), (t = y ? t.end : t.begin)),
                      'number' == typeof t)
                    ) {
                      (t = n ? t : ie(t)), (i = 'number' == typeof (i = n ? i : ie(i)) ? i : t);
                      var d =
                        parseInt(
                          ((e.ownerDocument.defaultView || r).getComputedStyle
                            ? (e.ownerDocument.defaultView || r).getComputedStyle(e, null)
                            : e.currentStyle
                          ).fontSize
                        ) * i;
                      if (
                        ...
                        o.insertModeVisual && !1 === o.insertMode && t === i && (l || i++),
                  ...
                  function ae(e) {
                    var t,
                      ...
                      o = C(),
                      l = {},
                      c = i.validPositions[o],
                      d = void 0 !== c ? c.locator.slice() : void 0;
                    for (t = o + 1; t < r.length; t++)
                      (d = (n = L(t, d, t - 1)).locator.slice()), (l[t] = a.extend(!0, {}, n));
                    var u = c && void 0 !== c.alternation ? c.locator[c.alternation] : void 0;
                    for (
                      t = s - 1;
                      o < t &&
                      ((n = l[t]).match.optionality ||
                        (n.match.optionalQuantifier && n.match.newBlockMarker) ||
                        (u &&
                          ((u !== l[t].locator[c.alternation] && 1 != n.match.static) ||
                            (!0 === n.match.static &&
                              n.locator[c.alternation] &&
                              B(n.locator[c.alternation].toString().split(','), u.toString().split(',')) &&
                              '' !== I(t)[0].def)))) &&
                      r[t] === K(t, n.match);
                      t--
                    )
                  ...
                  function re(e) {
                    e.length = 0;
                    for (var t, i = _(!0, 0, !0, void 0, !0); void 0 !== (t = i.shift()); ) e.push(t);
                    return e;
                  }
                  function se(e) {
                    if (a.isFunction(o.isComplete)) return o.isComplete(e, o);
                    if ('*' !== o.repeat) {
                      var t = !1,
                        n = ae(!0),
                        r = W(n.l);
                  ...
                  function oe(e, t, n, a, r) {
                    ...
                    if (
                      (t === p.BACKSPACE
                        ? n.end - n.begin < 1 && (n.begin = W(n.begin))
                        : t === p.DELETE && n.begin === n.end && (n.end = $(n.end, !0, !0) ? n.end + 1 : H(n.end) + 1),
                      !1 !== (l = V(n)))
                    ) {
                      if (
                        (!0 !== a && !1 !== o.keepStatic) ||
                        (null !== o.regex && -1 !== O(n.begin).match.def.indexOf('|'))
                      ) {
                        var c = R(!0);
                        if (c) {
                          var d =
                            void 0 !== c.caret ? c.caret : c.pos ? H(c.pos.begin ? c.pos.begin : c.pos) : C(-1, !0);
                          (t !== p.DELETE || n.begin > d) && n.begin;
                        }
                      }
                      !0 !== a && (i.p = t === p.DELETE ? n.begin + l : n.begin);
                    }
                  }
                  function le(e, t) {
                    (e.inputmask.refreshValue = !1),
                      a.isFunction(o.onBeforeMask) && (t = o.onBeforeMask.call(v, t, o) || t),
                      ee(e, !0, !1, (t = t.toString().split(''))),
                      (f = F().join('')),
                      (o.clearMaskOnLostFocus || o.clearIncomplete) &&
                        e.inputmask._valueGet() === j().join('') &&
                        -1 === C() &&
                  ...
                  if (void 0 !== t)
                    switch (t.action) {
                      ...
                      case 'unmaskedvalue':
                        return (
                          (void 0 !== g && void 0 === t.value) ||
                            ((Q = t.value),
                            (Q = ((a.isFunction(o.onBeforeMask) && o.onBeforeMask.call(v, Q, o)) || Q).split('')),
                            ee.call(this, void 0, !1, !1, Q),
                            a.isFunction(o.onBeforeWrite) && o.onBeforeWrite.call(v, void 0, F(), 0, o)),
                          te(g)
                        );
                      case 'mask':
                        !(function (e) {
                          ...
                          var t = (function (e, t) {
                            ...
                            var i = e.getAttribute('type'),
                              r =
                                ('input' === e.tagName.toLowerCase() && -1 !== a.inArray(i, t.supportsInputType)) ||
                                e.isContentEditable ||
                                        ...
                                        ? this.inputmask.opts.autoUnmask
                                          ...
                                          : -1 !== C() || !0 !== t.nullable
                                            ? (this.inputmask.shadowRoot || s.activeElement) === this &&
                                              ...
                                              ? (y ? re(F().slice()).reverse() : re(F().slice())).join('')
                                              : i.call(this)
                                            : ''
                                        : i.call(this);
                                    }
                                    function l(e) {
                                      r.call(this, e), this.inputmask && le(this, e);
                                    }
                                    if (!e.inputmask.__valueGet) {
                                      if (!0 !== t.noValuePatching) {
                                        if (Object.getOwnPropertyDescriptor) {
                                          ...
                                          c && c.get && c.set
                                            ? ((i = c.get),
                                              (r = c.set),
                                              Object.defineProperty(e, 'value', { get: o, set: l, configurable: !0 }))
                                      ...
                                      (e.inputmask._valueGet = function (e) {
                                        ...
                                        (e.inputmask._valueSet = function (e, t) {
                                          r.call(
                                            this.el,
                                            null == e ? '' : !0 !== t && y ? e.split('').reverse().join('') : e
                                          );
                                        }),
                                        void 0 === i &&
                                          ((i = function () {
                                          ...
                                          (function (e) {
                                            if (
                                              a.valHooks &&
                                              (void 0 === a.valHooks[e] || !0 !== a.valHooks[e].inputmaskpatch)
                                            ) {
                                              var i =
                                                  a.valHooks[e] && a.valHooks[e].get
                                                    ? a.valHooks[e].get
                                                    : function (e) {
                                                        return e.value;
                                                      },
                                                n =
                                                  a.valHooks[e] && a.valHooks[e].set
                                                    ? a.valHooks[e].set
                                                    : function (e, t) {
                                                        return (e.value = t), e;
                                                      };
                                              a.valHooks[e] = {
                                                get: function (e) {
                                                  if (e.inputmask) {
                                                    ...
                                                    var n = i(e);
                                                    return -1 !==
                                                      C(void 0, void 0, e.inputmask.maskset.validPositions) ||
                                                      !0 !== t.nullable
                                                      ? n
                                                      : '';
                                                  }
                                          ...
                                          (function (e) {
                                            J.on(e, 'mouseenter', function () {
                                              ...
                                              e !== (y ? F().reverse() : F()).join('') && le(this, e);
                                            });
                                          })(e));
                                    }
                                  })(e)
                          ...
                          if (!1 !== t) {
                            (m = a((g = e))),
                              (E = g.placeholder),
                              -1 === (h = void 0 !== g ? g.maxLength : void 0) && (h = void 0),
                              'inputMode' in g &&
                                null === g.getAttribute('inputmode') &&
                                ((g.inputMode = o.inputmode), g.setAttribute('inputmode', o.inputmode)),
                              !0 === t &&
                                ((o.showMaskOnFocus =
                                  o.showMaskOnFocus && -1 === ['cc-number', 'cc-exp'].indexOf(g.autocomplete)),
                                u && (o.insertModeVisual = !1),
                                ...
                                J.on(g, 'complete', o.oncomplete),
                                J.on(g, 'incomplete', o.onincomplete),
                                J.on(g, 'cleared', o.oncleared),
                              ...
                              (f = j().join(''));
                            var i = (g.inputmask.shadowRoot || s).activeElement;
                            if ('' !== g.inputmask._valueGet(!0) || !1 === o.clearMaskOnLostFocus || i === g) {
                              le(g, g.inputmask._valueGet(!0));
                              var r = F().slice();
                              !1 === se(r) && o.clearIncomplete && T(),
                                o.clearMaskOnLostFocus && i !== g && (-1 === C() ? (r = []) : re(r)),
                                (!1 === o.clearMaskOnLostFocus ||
                                  (o.showMaskOnFocus && i === g) ||
                      ...
                      case 'format':
                        return (
                          (Q = ((a.isFunction(o.onBeforeMask) && o.onBeforeMask.call(v, t.value, o)) || t.value).split(
                            ''
                          )),
                          ee.call(this, void 0, !0, !1, Q),
                          t.metadata
                            ? {
                                value: y ? F().slice().reverse().join('') : F().join(''),
                                metadata: e.call(this, { action: 'getmetadata' }, i, o),
                              }
                            : y
                      ...
                      case 'isValid':
                        t.value
                          ? ((Q = (
                              (a.isFunction(o.onBeforeMask) && o.onBeforeMask.call(v, t.value, o)) ||
                              t.value
                            ).split('')),
                            ee.call(this, void 0, !0, !1, Q))
                          : (t.value = y ? F().slice().reverse().join('') : F().join(''));
                        for (var ce = F(), de = ae(), ue = ce.length - 1; de < ue && !$(ue); ue--);
                        return (
                          ce.splice(de, ue + 1 - de),
                          se(ce) && t.value === (y ? F().slice().reverse().join('') : F().join(''))
                        );
                      case 'getemptymask':
                        return j().join('');
                      case 'remove':
                        if (g && g.inputmask) {
                          a.data(g, '_inputmask_opts', null), (m = a(g));
                          var pe = o.autoUnmask ? te(g) : g.inputmask._valueGet(o.autoUnmask);
                          pe !== j().join('') ? g.inputmask._valueSet(pe, o.autoUnmask) : g.inputmask._valueSet(''),
                            J.off(g),
                      ...
                      case 'getmetadata':
                        if (a.isArray(i.metadata)) {
                          var fe = _(!0, 0, !1).join('');
                          return (
                            a.each(i.metadata, function (e, t) {
              ...
              function (e, t, i) {
                ...
                function u(e, t, i, n) {
                  var r,
                    s,
                    o = '';
                  for (d(i).lastIndex = 0; (r = d(i).exec(e)); )
                    if (void 0 === t)
                      if ((s = c(r))) o += '(' + s[0] + ')';
                      else
                        switch (r[0]) {
                ...
                function f(e, t, i) {
                  ...
                  function u(e, t, i) {
                    (e[a] = (function (e) {
                      ...
                      (e['raw' + a] = t),
                      void 0 !== s && s.call(e.date, 'month' == a ? parseInt(e[a]) - 1 : e[a]);
                  }
                  if ('string' == typeof c) {
                    for (d(i).lastIndex = 0; (r = d(i).exec(t)); ) {
                      var p = c.slice(0, r[0].length);
                      o.hasOwnProperty(r[0]) && ((a = o[r[0]][2]), (s = o[r[0]][1]), u(l, p)), (c = c.slice(p.length));
                    }
                    return l;
                  }
                ...
                function m(e, t) {
                  var i,
                    n = '';
                  for (d(t).lastIndex = 0; (i = d(t).exec(t.inputFormat)); )
                    'd' === i[0].charAt(0)
                      ? (n += p(e.getDate(), i[0].length))
                      : 'm' === i[0].charAt(0)
                        ? (n += p(e.getMonth() + 1, i[0].length))
                        : 'yyyy' === i[0]
                          ? (n += e.getFullYear().toString())
                          : 'y' === i[0].charAt(0) && (n += p(e.getYear(), i[0].length));
                  return n;
                }
                function h(e, t) {
                  var i,
                    n,
                    a = 0;
                  for (d(t).lastIndex = 0; (n = d(t).exec(t.inputFormat)); )
                    if (e <= (a += n[0].length)) {
                      (i = n), (n = d(t).exec(t.inputFormat));
                      break;
                    }
                  ...
                  datetime: {
                    mask: function (e) {
                      return (
                        ...
                        (e.regex = u(e.inputFormat, void 0, e)),
                    ...
                    preValidation: function (e, t, i, n, a, r, s, l) {
                      if (l) return !0;
                      if (isNaN(i) && e[t] !== i) {
                        var c = h(t, a);
                        if (c.nextMatch && c.nextMatch[0] === i && 1 < c.targetMatch[0].length) {
                          var d = o[c.targetMatch[0]][0];
                    ...
                    postValidation: function (e, t, i, n, a, r, s) {
                      ...
                      if (
                        ...
                        (l = h(t, a)).targetMatch && l.targetMatch[0] && void 0 !== o[l.targetMatch[0]])
                      ) {
                        c = o[l.targetMatch[0]][0];
                        var d = e.slice(l.targetMatch.index, l.targetMatch.index + l.targetMatch[0].length);
                        !1 === new RegExp(c).test(d.join('')) &&
                          2 === l.targetMatch[0].length &&
                          r.validPositions[l.targetMatch.index] &&
                          r.validPositions[l.targetMatch.index + 1] &&
                          (r.validPositions[l.targetMatch.index + 1].input = '0');
                      }
                      var p = n,
                        m = f(e.join(''), a.inputFormat, a);
                      return (
                        p &&
                        ...
                        t && p && n.pos !== t
                          ? { buffer: u(a.inputFormat, m, a).split(''), refreshFromBuffer: { start: t, end: n.pos } }
                          : p
                      );
                    },
                    onKeyDown: function (e, t, i, n) {
                      e.ctrlKey &&
                        e.keyCode === s.RIGHT &&
                        (this.inputmask._valueSet(m(new Date(), n)), r(this).trigger('setvalue'));
                    },
                    onUnMask: function (e, t, i) {
                      return t ? u(i.outputFormat, f(e, i.inputFormat, i), i, !0) : t;
                    },
              ...
              function (e, t, i) {
                ...
                function s(e, t) {
                  for (var i = '', a = 0; a < e.length; a++)
                    n.prototype.definitions[e.charAt(a)] ||
                ...
                function o(e, t, i, n) {
                  if (0 < t && (!i.digitsOptional || n)) {
                    var r = a.inArray(i.radixPoint, e);
                ...
                function c(e, t) {
                  var i = -1;
                  return (
                    a.each(t.validPositions, function (t, n) {
                  ...
                  numeric: {
                    mask: function (e) {
                      ...
                      return (
                        (r += s(e.suffix, e)),
                        (r += '[-]'),
                        a && (r = [a + s(e.suffix, e) + '[-]', r]),
                        (e.greedy = !1),
                        (function (e) {
                          void 0 === e.parseMinMaxOptions &&
                            (null !== e.min &&
                              ((e.min = e.min.toString().replace(new RegExp(n.escapeRegex(e.groupSeparator), 'g'), '')),
                              ',' === e.radixPoint && (e.min = e.min.replace(e.radixPoint, '.')),
                              (e.min = isFinite(e.min) ? parseFloat(e.min) : NaN),
                              isNaN(e.min) && (e.min = Number.MIN_VALUE)),
                            null !== e.max &&
                              ((e.max = e.max.toString().replace(new RegExp(n.escapeRegex(e.groupSeparator), 'g'), '')),
                    ...
                    preValidation: function (e, t, i, n, r, s, o, d) {
                      if (!1 !== r.__financeInput && i === r.radixPoint) return !1;
                      var u;
                      if ((u = r.shortcuts && r.shortcuts[i])) {
                        if (1 < u.length)
                          for (var p = [], f = 0; f < u.length; f++) p.push({ pos: t + f, c: u[f], strict: !1 });
                        return { insert: p };
                      }
                      var m = a.inArray(r.radixPoint, e),
                        h = t;
                      if (
                        ...
                        return (
                          ...
                          !1 !== v
                            ...
                            : {
                                insert: [
                                  { pos: l('+', s), c: r.negationSymbol.front, fromIsValid: !0 },
                                  { pos: l('-', s), c: r.negationSymbol.back, fromIsValid: void 0 },
                                ],
                      ...
                      if (
                        ...
                        return { caret: r._radixDance && t === m - 1 ? m + 1 : m };
                      if (!1 === r.__financeInput)
                        if (n) {
                          if (r.digitsOptional) return { rewritePosition: o.end };
                          if (!r.digitsOptional) {
                            if (o.begin > m && o.end <= m)
                              return i === r.radixPoint
                                ? { insert: { pos: m + 1, c: '0', fromIsValid: !0 }, rewritePosition: m }
                                : { rewritePosition: m + 1 };
                            if (o.begin < m) return { rewritePosition: o.begin - 1 };
                          }
                        } else if (
                          !r.showMaskOnHover &&
                          !r.showMaskOnFocus &&
                    ...
                    postValidation: function (e, t, i, n, r, s, o) {
                      if (!1 === n) return n;
                      if (o) return !0;
                    ...
                    onUnMask: function (e, t, i) {
                      ...
                      return (
                        (a = (a = a.replace(i.suffix, '')).replace(
                          new RegExp(n.escapeRegex(i.groupSeparator), 'g'),
                          ''
                        )),
                        ...
                        i.unmaskAsNumber
                          ? ('' !== i.radixPoint &&
                              ...
                              (a = a.replace(n.escapeRegex.call(this, i.radixPoint), '.')),
                            (a = (a = a.replace(new RegExp('^' + n.escapeRegex(i.negationSymbol.front)), '-')).replace(
                              new RegExp(n.escapeRegex(i.negationSymbol.back) + '$'),
                              ''
                            )),
                            Number(a))
                          : a
                    ...
                    isComplete: function (e, t) {
                      ...
                      return (
                        (i = (i = (i = (i = (i = i.replace(
                          new RegExp('^' + n.escapeRegex(t.negationSymbol.front)),
                          '-'
                        )).replace(new RegExp(n.escapeRegex(t.negationSymbol.back) + '$'), '')).replace(
                          t.prefix,
                          ''
                        )).replace(t.suffix, '')).replace(
                          new RegExp(n.escapeRegex(t.groupSeparator) + '([0-9]{3})', 'g'),
                          '$1'
                        )),
                        ',' === t.radixPoint && (i = i.replace(n.escapeRegex(t.radixPoint), '.')),
                        isFinite(i)
                      );
                    },
                    onBeforeMask: function (e, t) {
                      ...
                      if (
                        ...
                        (e = e.replace(n.escapeRegex(i), '.')),
                          isFinite(e) && (e = (t.roundingFN(parseFloat(e) * d) / d).toFixed(c)),
                          (e = e.toString().replace('.', i));
                      }
                      if (
                        ...
                        null !== t.min && u < t.min
                          ...
                          : null !== t.max && u > t.max && (e = t.max.toString().replace('.', i));
                      }
                    ...
                    onBeforeWrite: function (e, t, i, r) {
                      function s(e, t) {
                        if (!1 !== r.__financeInput || t) {
                          var i = a.inArray(r.radixPoint, e);
                          -1 !== i && e.splice(i, 1);
                        }
                      ...
                      var l,
                        c = (function (e, t) {
                          var i = new RegExp(
                              '(^' +
                                ('' !== t.negationSymbol.front ? n.escapeRegex(t.negationSymbol.front) + '?' : '') +
                                n.escapeRegex(t.prefix) +
                                ')(.*)(' +
                                n.escapeRegex(t.suffix) +
                                ('' != t.negationSymbol.back ? n.escapeRegex(t.negationSymbol.back) + '?' : '') +
                                '$)'
                      ...
                      if (c) {
                        var d = t.slice().reverse(),
                          u = d.join('').indexOf(c[0]);
                        d.splice(u, c[0].length);
                        var p = d.length - u;
                        s(d), (l = { refreshFromBuffer: !0, buffer: d.reverse(), caret: i < p ? i : p });
                      }
                      if (e)
                        switch (e.type) {
                          case 'blur':
                          case 'checkval':
                            if (null !== r.min) {
                              ...
                              if (null !== r.min && f < r.min)
                                return {
                                  refreshFromBuffer: !0,
                                  buffer: o(
                                    r.min.toString().replace('.', r.radixPoint).split(''),
                                    r.digits,
                                    r
                                  ).reverse(),
                                };
                            ...
                            if (t[t.length - 1] === r.negationSymbol.front) {
                              var m = new RegExp(
                                '(^' +
                                  ('' != r.negationSymbol.front ? n.escapeRegex(r.negationSymbol.front) + '?' : '') +
                                  n.escapeRegex(r.prefix) +
                                  ')(.*)(' +
                                  n.escapeRegex(r.suffix) +
                                  ('' != r.negationSymbol.back ? n.escapeRegex(r.negationSymbol.back) + '?' : '') +
                                  '$)'
                            ...
                            if (r.enforceDigitsOnBlur) {
                              var h = ((l = l || {}) && l.buffer) || t.slice().reverse();
                              (l.refreshFromBuffer = !0), (l.buffer = o(h, r.digits, r, !0).reverse());
                            }
                        }
                      return l;
                    },
                    onKeyDown: function (e, t, i, n) {
                      ...
                      if (
                        !e.shiftKey &&
                        (e.keyCode === r.DELETE || e.keyCode === r.BACKSPACE || e.keyCode === r.BACKSPACE_SAFARI) &&
                        i.begin !== t.length
                      ) {
                        if (t[e.keyCode === r.DELETE ? i.begin - 1 : i.end] === n.negationSymbol.front)
                          return (
                            (s = t.slice().reverse()),
                            '' !== n.negationSymbol.front && s.shift(),
                            '' !== n.negationSymbol.back && s.pop(),
                            l.trigger('setvalue', [s.join(''), i.begin]),
                            !1
                          );
                        if (!0 === n._radixDance) {
                          var c = a.inArray(n.radixPoint, t);
                          if (n.digitsOptional) {
                            if (0 === c)
                              return (
                                (s = t.slice().reverse()).pop(),
                                l.trigger('setvalue', [s.join(''), i.begin >= s.length ? s.length : i.begin]),
                                !1
                              );
                          } else if (
                            -1 !== c &&
                            (i.begin < c || i.end < c || (e.keyCode === r.DELETE && i.begin === c))
                          )
                            return (
                              i.begin !== i.end ||
                                (e.keyCode !== r.BACKSPACE && e.keyCode !== r.BACKSPACE_SAFARI) ||
                                i.begin++,
                              (s = t.slice().reverse()).splice(s.length - i.begin, i.begin - i.end + 1),
                              (s = o(s, n.digits, n).join('')),
                              l.trigger('setvalue', [s, i.begin >= s.length ? c + 1 : i.begin]),
                              !1
                            );
                        }
                      }
              ...
              function (e, t, i) {
                var n,
                  a = (n = i(1)) && n.__esModule ? n : { default: n };
                function r(e) {
                  return (
                    (r =
                      'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                  ...
                  var d = (function (e) {
                    function t() {
                      ...
                      var i,
                        ...
                        (n = c(t).call(this)),
                        (e =
                          !n || ('object' !== r(n) && 'function' != typeof n)
                            ? (function (e) {
                                if (void 0 === e)
                      ...
                      for (var d in ((l.type = 'text'), o.appendChild(l), s))
                        Object.prototype.hasOwnProperty.call(s, d) &&
                          l.setAttribute('data-inputmask-' + s[d], e.getAttribute(s[d]));
                      return new a.default().mask(l), (l.inputmask.shadowRoot = o), e;
                    }
                    return (
                      (function (e, t) {
            ...
            (__nested_webpack_require_214173__.d = function (e, t, i) {
              __nested_webpack_require_214173__.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: i });
            }),
            (__nested_webpack_require_214173__.r = function (e) {
              'undefined' != typeof Symbol &&
                Symbol.toStringTag &&
                Object.defineProperty(e, Symbol.toStringTag, { value: 'Module' }),
                Object.defineProperty(e, '__esModule', { value: !0 });
            }),
            (__nested_webpack_require_214173__.t = function (e, t) {
              if ((1 & t && (e = __nested_webpack_require_214173__(e)), 8 & t)) return e;
              if (4 & t && 'object' == typeof e && e && e.__esModule) return e;
              var i = Object.create(null);
              if (
                (__nested_webpack_require_214173__.r(i),
            ...
            (__nested_webpack_require_214173__.n = function (e) {
              var t =
                e && e.__esModule
                  ? function () {
                      return e.default;
              ...
              return __nested_webpack_require_214173__.d(t, 'a', t), t;
            }),
            (__nested_webpack_require_214173__.o = function (e, t) {
              return Object.prototype.hasOwnProperty.call(e, t);
            }),
            (__nested_webpack_require_214173__.p = ''),
            __nested_webpack_require_214173__((__nested_webpack_require_214173__.s = 5))
          );
          function __nested_webpack_require_214173__(e) {
            if (installedModules[e]) return installedModules[e].exports;
            var t = (installedModules[e] = { i: e, l: !1, exports: {} });
            return modules[e].call(t.exports, t, t.exports, __nested_webpack_require_214173__), (t.l = !0), t.exports;
          }
  ...
  (() => {
    ...
    const e = 1366,
      t = (e, t, i) => {
        (e.style.opacity = 0),
          ...
          (e.style.transition = `opacity ${t}ms`),
          setTimeout(() => {
            e.style.opacity = 1;
          }, 10);
      };
      ...
      !(function () {
        ...
        e.forEach((e) => {
          if (e.classList.contains('steps-investor__item') && !t) {
            const i = e.querySelector('.js-dropdown-content'),
              n = i.scrollHeight;
            (i.style.height = `${n}px`), e.classList.add('active'), (t = !0);
          }
        });
      })(),
        ...
        (function () {
          ...
          if (e && window.innerWidth < 768) {
            const t = e.querySelector('span'),
              i = document.querySelector('.js-calc-items-content');
            e.addEventListener('click', () => {
              e.classList.contains('--hide')
                ? ((t.textContent = 'Показать еще'), e.classList.remove('--hide'), i.classList.add('--hide'))
                : ((t.textContent = 'Свернуть'), i.classList.remove('--hide'), e.classList.add('--hide'));
            });
          }
        })(),
        (function () {
          if (document.querySelector('.js-account-menu')) {
            const e = document.querySelector('.js-account-menu');
            document.querySelector('.js-account-menu-open').addEventListener('click', () => {
              e.classList.add('active'), document.body.classList.add('hidden');
            });
          }
        })(),
        document.querySelector('.js-add-org-btn') &&
          document.querySelector('.js-add-org-btn').addEventListener('click', () => {
            const e = document.querySelector('.account__fieldset.--active'),
              i = e.querySelector('.account__fieldset-subtitles'),
              n = e.querySelector('.account__fieldset-block--new');
            t(i, 750, 'flex'), t(n, 750, 'block');
          }),
        (function () {
          if (document.querySelector('.js-toggles')) {
            const e = document.querySelector('.js-toggles').querySelectorAll('.js-toggle');
            e.forEach((t) => {
              t.addEventListener('click', () => {
            ...
            void 0 !== r &&
              ...
              (d(e[n]) && d(a[n])
                ? a[n].__swiper__
                  ...
                  : u(e[n], a[n])
                : !d(e[n]) && d(a[n])
                  ? ((e[n] = {}), a[n].__swiper__ ? (e[n] = a[n]) : u(e[n], a[n]))
                  : (e[n] = a[n]));
          }
        }
      }
    ...
    const T = (e, t) => {
      ...
      P = (e) => {
        ...
        if (e.params.rewind || e.params.loop)
          ...
          for (let n = Math.max(a - t, 0); n <= Math.min(r + t, i - 1); n += 1) n !== a && (n > r || n < a) && C(e, n);
      };
    var M = {
      updateSize: function () {
        const e = this;
        ...
        (t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : n.clientWidth),
          ...
          (0 === t && e.isHorizontal()) ||
            (0 === i && e.isVertical()) ||
            ((t = t - parseInt(g(n, 'padding-left') || 0, 10) - parseInt(g(n, 'padding-right') || 0, 10)),
            (i = i - parseInt(g(n, 'padding-top') || 0, 10) - parseInt(g(n, 'padding-bottom') || 0, 10)),
            Number.isNaN(t) && (t = 0),
            Number.isNaN(i) && (i = 0),
      ...
      updateSlides: function () {
        ...
        const i = e.params,
          { wrapperEl: n, slidesEl: a, size: r, rtlTranslate: s, wrongRTL: o } = e,
          l = e.virtual && i.virtual.enabled,
          c = l ? e.virtual.slides.length : e.slides.length,
          d = m(a, `.${e.params.slideClass}, swiper-slide`),
        ...
        'string' == typeof x && x.indexOf('%') >= 0
          ...
          i.centeredSlides &&
            i.cssMode &&
            (p(n, '--swiper-centered-offset-before', ''), p(n, '--swiper-centered-offset-after', ''));
        ...
        for (let n = 0; n < u; n += 1) {
          let a;
          if (((P = 0), d[n] && (a = d[n]), C && e.grid.updateSlide(n, a, d), !d[n] || 'none' !== g(a, 'display'))) {
            if ('auto' === i.slidesPerView) {
              M && (d[n].style[e.getDirectionLabel('width')] = '');
              const r = getComputedStyle(a),
                s = a.style.transform,
                o = a.style.webkitTransform;
              if ((s && (a.style.transform = 'none'), o && (a.style.webkitTransform = 'none'), i.roundLengths))
              ...
              s && (a.style.transform = s), o && (a.style.webkitTransform = o), i.roundLengths && (P = Math.floor(P));
            } else
              (P = (r - (i.slidesPerView - 1) * x) / i.slidesPerView),
                i.roundLengths && (P = Math.floor(P)),
                d[n] && (d[n].style[e.getDirectionLabel('width')] = `${P}px`);
            d[n] && (d[n].swiperSlideSize = P),
              v.push(P),
              i.centeredSlides
                ? ((E = E + P / 2 + _ / 2 + x),
                  0 === _ && 0 !== n && (E = E - r / 2 - x),
                  ...
                  T % i.slidesPerGroup == 0 && f.push(E),
                  h.push(E))
                : (i.roundLengths && (E = Math.floor(E)),
                  (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && f.push(E),
                  h.push(E),
                  (E = E + P + x)),
              (e.virtualSize += P + x),
              (_ = P),
        ...
        if (
          ...
          s && o && ('slide' === i.effect || 'coverflow' === i.effect) && (n.style.width = `${e.virtualSize + x}px`),
          i.setWrapperSize && (n.style[e.getDirectionLabel('width')] = `${e.virtualSize + x}px`),
          ...
          for (let n = 0; n < f.length; n += 1) {
            let a = f[n];
            i.roundLengths && (a = Math.floor(a)), f[n] <= e.virtualSize - r && t.push(a);
          }
        ...
        if (l && i.loop) {
          ...
          if (i.slidesPerGroup > 1) {
            ...
            for (let e = 0; e < n; e += 1) f.push(f[f.length - 1] + a);
          }
          for (let n = 0; n < e.virtual.slidesBefore + e.virtual.slidesAfter; n += 1)
            1 === i.slidesPerGroup && f.push(f[f.length - 1] + t), h.push(h[h.length - 1] + t), (e.virtualSize += t);
        }
        ...
        if (
          (Object.assign(e, { slides: d, snapGrid: f, slidesGrid: h, slidesSizesGrid: v }),
          i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)
        ) {
          p(n, '--swiper-centered-offset-before', -f[0] + 'px'),
            p(n, '--swiper-centered-offset-after', e.size / 2 - v[v.length - 1] / 2 + 'px');
        ...
        if (
          ...
          f.length !== k && (e.params.watchOverflow && e.checkOverflow(), e.emit('snapGridLengthChange')),
      ...
      updateSlidesProgress: function (e) {
        ...
        for (let e = 0; e < n.length; e += 1) {
          ...
          ((p >= 0 && p < t.size - 1) || (f > 1 && f <= t.size) || (p <= 0 && f >= t.size)) &&
            ...
            m && n[e].classList.add(i.slideFullyVisibleClass),
            (l.progress = a ? -d : d),
      ...
      updateProgress: function (e) {
        ...
        Object.assign(t, { progress: a, progressLoop: o, isBeginning: r, isEnd: s }),
      ...
      updateSlidesClasses: function () {
        const e = this,
          ...
          o = (e) => m(n, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
        let l, c, d;
        if (
          (t.forEach((e) => {
        ...
        l &&
          ...
          s
            ? (d && d.classList.add(i.slideNextClass), c && c.classList.add(i.slidePrevClass))
            : ((d = (function (e, t) {
                const i = [];
    ...
    var L = {
        slideTo: function (e, t, i, n, a) {
          ...
          let g = v + Math.floor((s - v) / r.params.slidesPerGroup);
          ...
          if (r.initialized && s !== u) {
            if (
              !r.allowSlideNext &&
              (p ? y > r.translate && y > r.minTranslate() : y < r.translate && y < r.minTranslate())
            )
              return !1;
          ...
          if (o.cssMode) {
            ...
            if (0 === t) {
              ...
              if (!r.support.smoothScroll) return f({ swiper: r, targetPosition: i, side: e ? 'left' : 'top' }), !0;
          ...
          if (a.params.loop)
            if (a.virtual && a.params.virtual.enabled) s += a.virtual.slidesBefore;
              ...
              const t = r ? Math.ceil(a.slides.length / a.params.grid.rows) : a.slides.length,
                { centeredSlides: i } = a.params;
              let n = a.params.slidesPerView;
              'auto' === n
                ? (n = a.slidesPerViewDynamic())
                : ((n = Math.ceil(parseFloat(a.params.slidesPerView, 10))), i && n % 2 == 0 && (n += 1));
              let o = t - e < n;
            ...
            (a = parseInt(e.clickedSlide.getAttribute('data-swiper-slide-index'), 10)),
              t.centeredSlides
                ? r < e.loopedSlides - n / 2 || r > e.slides.length - e.loopedSlides + n / 2
                  ? (e.loopFix(),
                    (r = e.getSlideIndex(m(i, `${s}[data-swiper-slide-index="${a}"]`)[0])),
                    l(() => {
                      e.slideTo(r);
                    }))
                  : e.slideTo(r)
      ...
      O = {
        ...
        loopFix: function (e) {
          ...
          let _ = 0,
            T = 0;
          const C = b ? Math.ceil(c.length / f.grid.rows) : c.length,
            P = (b ? c[r].column : r) + (m && void 0 === a ? -v / 2 + 0.5 : 0);
          if (P < y) {
            _ = Math.max(y - P, g);
          ...
          if (
            ...
            if (w.length > 0 && E) {
              ...
              if (void 0 === t) {
                ...
                const e = b ? k.length / f.grid.rows : k.length;
                l.slideTo(l.activeIndex - e, 0, !1, !0);
              }
          if (((l.allowSlidePrev = d), (l.allowSlideNext = u), l.controller && l.controller.control && !s)) {
            const e = { slideRealIndex: t, direction: n, setTranslate: a, activeSlideIndex: r, byController: !0 };
    ...
    function I(e) {
      ...
      const { params: s, touches: l, enabled: d } = t;
      if (!d) return;
      ...
      p && n.target && n.target.shadowRoot && f && (u = f[0]);
      ...
      (!s.touchStartForcePreventDefault && !b) || u.isContentEditable || n.preventDefault(),
    ...
    function j(e) {
      ...
      if ('touchmove' === u.type) {
        if (
          ((d = [...u.changedTouches].filter((e) => e.identifier === n.touchId)[0]), !d || d.identifier !== n.touchId)
        )
          return;
      } else d = u;
      if (!n.isTouched) return void (n.startMoving && n.isScrolling && i.emit('touchMoveOpposite', u));
      const p = d.pageX,
        f = d.pageY;
      ...
      if (!i.allowTouchMove)
        return (
          ...
          void (
            n.isTouched &&
            (Object.assign(s, { startX: p, startY: f, currentX: p, currentY: f }), (n.touchStartTime = c()))
          )
        );
      if (a.touchReleaseOnEdges && !a.loop)
        if (i.isVertical()) {
          ...
          return;
      if (t.activeElement && u.target === t.activeElement && u.target.matches(n.focusableElements))
      ...
      let v = i.isHorizontal() ? m : h,
        g = i.isHorizontal() ? s.currentX - s.previousX : s.currentY - s.previousY;
      a.oneWayMovement && ((v = Math.abs(v) * (o ? 1 : -1)), (g = Math.abs(g) * (o ? 1 : -1))),
        (s.diff = v),
        (v *= a.touchRatio),
        o && ((v = -v), (g = -g));
      ...
      if (
        (new Date().getTime(),
        n.isMoved && n.allowThresholdMove && y !== i.touchesDirection && b && w && Math.abs(v) >= 1)
      )
        return (
          Object.assign(s, { startX: p, startY: f, currentX: p, currentY: f, startTranslate: n.currentTranslate }),
          (n.loopSwapReset = !0),
          void (n.startTranslate = n.currentTranslate)
        );
      i.emit('sliderMove', u), (n.isMoved = !0), (n.currentTranslate = v + n.startTranslate);
      let k = !0,
        S = a.resistanceRatio;
      if (
        ...
        v > 0
          ? (b &&
              ...
              n.currentTranslate >
                (a.centeredSlides ? i.minTranslate() - i.slidesSizesGrid[i.activeIndex + 1] : i.minTranslate()) &&
              i.loopFix({ direction: 'prev', setTranslate: !0, activeSlideIndex: 0 }),
            n.currentTranslate > i.minTranslate() &&
              ((k = !1),
              a.resistance &&
                (n.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + n.startTranslate + v) ** S)))
          : v < 0 &&
            (b &&
              w &&
              n.allowThresholdMove &&
              ...
              i.loopFix({
                ...
                activeSlideIndex:
                  i.slides.length -
                  ('auto' === a.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(a.slidesPerView, 10))),
              }),
            n.currentTranslate < i.maxTranslate() &&
              ((k = !1),
              a.resistance &&
                (n.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - n.startTranslate - v) ** S))),
    ...
    function F(e) {
      ...
      if ((a.originalEvent && (a = a.originalEvent), 'touchend' === a.type || 'touchcancel' === a.type)) {
        if (
          ((n = [...a.changedTouches].filter((e) => e.identifier === i.touchId)[0]), !n || n.identifier !== i.touchId)
        )
          return;
      } else {
      ...
      const { params: r, touches: s, rtlTranslate: o, slidesGrid: d, enabled: u } = t;
      if (!u) return;
      if (!r.simulateTouch && 'mouse' === a.pointerType) return;
      if ((i.allowTouchCallbacks && t.emit('touchEnd', a), (i.allowTouchCallbacks = !1), !i.isTouched))
      ...
      if (t.allowClick) {
        ...
        t.updateClickedSlide((e && e[0]) || a.target, e),
          t.emit('tap click', a),
          f < 300 && p - i.lastClickTime < 300 && t.emit('doubleTap doubleClick', a);
      }
      if (
        ((i.lastClickTime = c()),
        l(() => {
      ...
      if (
        ...
        (i.isMoved = !1),
        (i.startMoving = !1),
        (m = r.followFinger ? (o ? t.translate : -t.translate) : -i.currentTranslate),
        r.cssMode)
      )
        return;
      if (r.freeMode && r.freeMode.enabled) return void t.freeMode.onTouchEnd({ currentPos: m });
      ...
      for (let e = 0; e < d.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
        ...
        void 0 !== d[e + t]
          ...
          : (h || m >= d[e]) && ((v = e), (g = d[d.length - 1] - d[d.length - 2]));
      }
      let y = null,
        b = null;
      r.rewind &&
        (t.isBeginning
          ...
          : t.isEnd && (y = 0));
      const w = (m - d[v]) / g,
        k = v < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
      if (f > r.longSwipesMs) {
        if (!r.longSwipes) return void t.slideTo(t.activeIndex);
        'next' === t.swipeDirection &&
          (w >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? y : v + k) : t.slideTo(v)),
        ...
        !t.navigation || (a.target !== t.navigation.nextEl && a.target !== t.navigation.prevEl)
          ? ('next' === t.swipeDirection && t.slideTo(null !== y ? y : v + k),
    ...
    function R(e) {
      const t = this;
      T(t, e.target), t.params.cssMode || ('auto' !== t.params.slidesPerView && !t.params.autoHeight) || t.update();
    }
    function z() {
      const e = this;
    ...
    const N = (e, t) => {
        const i = r(),
          { params: n, el: a, wrapperEl: s, device: o } = e,
          l = !!n.nested,
        ...
        i[c]('touchstart', e.onDocumentTouchStart, { passive: !1, capture: l }),
          ...
          (n.preventClicks || n.preventClicksPropagation) && a[c]('click', e.onClick, !0),
          n.cssMode && s[c]('scroll', e.onScroll),
          n.updateOnWindowResize
            ? e[d](o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', q, !0)
          ...
          translateTo: function (e, t, i, n, a) {
            ...
            if (((d = n && e > l ? l : n && e < c ? c : e), r.updateProgress(d), s.cssMode)) {
              ...
              if (0 === t) o[e ? 'scrollLeft' : 'scrollTop'] = -d;
                ...
                if (!r.support.smoothScroll) return f({ swiper: r, targetPosition: -d, side: e ? 'left' : 'top' }), !0;
        ...
        transition: {
          ...
          transitionStart: function (e, t) {
            ...
            const i = this,
              { params: n } = i;
            n.cssMode ||
              (n.autoHeight && i.updateAutoHeight(), A({ swiper: i, runCallbacks: e, direction: t, step: 'Start' }));
          },
          transitionEnd: function (e, t) {
            ...
            const i = this,
              { params: n } = i;
            (i.animating = !1),
              n.cssMode || (i.setTransition(0), A({ swiper: i, runCallbacks: e, direction: t, step: 'End' }));
          },
        },
        slide: L,
        loop: O,
    ...
    class K {
      ...
      getSlideIndex(e) {
        const { slidesEl: t, params: i } = this,
          n = y(m(t, `.${i.slideClass}, swiper-slide`)[0]);
        return y(e) - n;
      }
      ...
      mount(e) {
        ...
        let a = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(n()) : m(i, n())[0];
        return (
          !a &&
          ...
          Object.assign(t, {
            ...
            rtlTranslate:
              'horizontal' === t.params.direction && ('rtl' === i.dir.toLowerCase() || 'rtl' === g(i, 'direction')),
      ...
      return (
        e.params.createElements &&
          Object.keys(n).forEach((a) => {
            if (!i[a] && !0 === i.auto) {
              let r = m(e.el, `.${n[a]}`)[0];
              r || ((r = v('div', n[a])), (r.className = n[a]), e.el.append(r)), (i[a] = r), (t[a] = r);
            }
          }),
        i
      );
    ...
    function J(e) {
      ...
      function p() {
        ...
        if (
          ...
          if (
            (i.dynamicBullets &&
              ((s = w(a[0], t.isHorizontal() ? 'width' : 'height', !0)),
              u.forEach((e) => {
                e.style[t.isHorizontal() ? 'width' : 'height'] = s * (i.dynamicMainBullets + 4) + 'px';
              }),
              i.dynamicMainBullets > 1 &&
                void 0 !== r &&
                ((o += n - (r || 0)), o > i.dynamicMainBullets - 1 ? (o = i.dynamicMainBullets - 1) : o < 0 && (o = 0)),
              (l = Math.max(n - o, 0)),
              (c = l + (Math.min(a.length, i.dynamicMainBullets) - 1)),
              (p = (c + l) / 2)),
            a.forEach((e) => {
              const t = [
                ...['', '-next', '-next-next', '-prev', '-prev-prev', '-main'].map((e) => `${i.bulletActiveClass}${e}`),
              ]
        ...
        'fraction' === e.type &&
          ...
          n.forEach((i) => {
            'custom' !== e.type && (i.innerHTML = r || ''),
              'bullets' === e.type && t.pagination.bullets.push(...i.querySelectorAll(Q(e.bulletClass)));
          }),
      ...
      n('changeDirection', () => {
        ...
        n('click', (e, i) => {
          ...
          if (
            ...
            if (
              t.navigation &&
              ((t.navigation.nextEl && n === t.navigation.nextEl) || (t.navigation.prevEl && n === t.navigation.prevEl))
            )
              return;
    ...
    function Z(e) {
      let t,
        i,
        { swiper: n, extendParams: a, on: s, emit: o, params: l } = e;
      ...
      function w(e) {
        n &&
          ...
          (n.wrapperEl.removeEventListener('transitionend', w), v || T());
      }
      const k = () => {
          if (n.destroyed || !n.autoplay.running) return;
          n.autoplay.paused ? (d = !0) : d && ((y = c), (d = !1));
          const e = n.autoplay.paused ? c : b + y - new Date().getTime();
        ...
        S = (e) => {
          ...
          !Number.isNaN(r) && r > 0 && void 0 === e && ((a = r), (g = r), (y = r)), (c = a);
              ...
              n &&
                ...
                (n.params.autoplay.reverseDirection
                  ? !n.isBeginning || n.params.loop || n.params.rewind
                    ...
                    : n.params.autoplay.stopOnLastSlide || (n.slideTo(n.slides.length - 1, s, !0, !0), o('autoplay'))
                  : !n.isEnd || n.params.loop || n.params.rewind
                    ? (n.slideNext(s, !0, !0), o('autoplay'))
                    : n.params.autoplay.stopOnLastSlide || (n.slideTo(0, s, !0, !0), o('autoplay')),
                n.params.cssMode &&
                  ((b = new Date().getTime()),
                  requestAnimationFrame(() => {
                    S();
        ...
        x = () => {
          (b = new Date().getTime()), (n.autoplay.running = !0), S(), o('autoplayStart');
        },
        E = () => {
        ...
        _ = (e, i) => {
          ...
          const a = () => {
            o('autoplayPause'),
              n.params.autoplay.waitForTransition ? n.wrapperEl.addEventListener('transitionend', w) : T();
          };
          if (((n.autoplay.paused = !0), i)) return m && (c = n.params.autoplay.delay), (m = !1), void a();
          const r = c || n.params.autoplay.delay;
          (c = r - (new Date().getTime() - b)), (n.isEnd && c < 0 && !n.params.loop) || (c < 0 && (c = 0), a());
        },
        T = () => {
          (n.isEnd && c < 0 && !n.params.loop) ||
            n.destroyed ||
            !n.autoplay.running ||
            ((b = new Date().getTime()), h ? ((h = !1), S(c)) : S(), (n.autoplay.paused = !1), o('autoplayResume'));
        },
        C = () => {
          if (n.destroyed || !n.autoplay.running) return;
          const e = r();
          'hidden' === e.visibilityState && ((h = !0), _(!0)), 'visible' === e.visibilityState && T();
        },
        P = (e) => {
          'mouse' === e.pointerType && ((h = !0), (v = !0), n.animating || n.autoplay.paused || _(!0));
        },
        M = (e) => {
          'mouse' === e.pointerType && ((v = !1), n.autoplay.paused && T());
        };
      s('init', () => {
        n.params.autoplay.enabled &&
          (n.params.autoplay.pauseOnMouseEnter &&
            (n.el.addEventListener('pointerenter', P), n.el.addEventListener('pointerleave', M)),
        ...
        s('_freeModeNoMomentumRelease', () => {
          n.params.autoplay.disableOnInteraction ? E() : _(!0, !0);
        }),
        s('beforeTransitionStart', (e, t, i) => {
          !n.destroyed && n.autoplay.running && (i || !n.params.autoplay.disableOnInteraction ? _(!0, !0) : E());
        }),
        s('sliderFirstMove', () => {
          !n.destroyed &&
            n.autoplay.running &&
        ...
        s('touchEnd', () => {
          if (!n.destroyed && n.autoplay.running && u) {
            if ((clearTimeout(f), clearTimeout(t), n.params.autoplay.disableOnInteraction))
              return (p = !1), void (u = !1);
        ...
        Object.assign(n.autoplay, { start: x, stop: E, pause: _, resume: T });
    }
    function ee(e, t, i, n, a) {
      if (document.querySelector(`.${t}`)) {
        ...
        for (let t = 0; t < e.length; t += a) {
          ...
          s.classList.add('swiper-slide', `${i}`);
          for (let i = t; i < t + a && i < e.length; i += 1) {
            const t = document.createElement('div');
            t.classList.add(`${n}`), (t.innerHTML = e[i].innerHTML), s.appendChild(t);
          }
          r.appendChild(s);
        }
      }
    ...
    const te = { news: { card: 'news__card', slider: 'news__slider', slide: 'news__slide', counts: [5, 3, 1] } };
    function ie() {
      ...
      !(function () {
        if (document.querySelector('.benefits__swiper')) {
          const e = document.querySelector('.benefits__swiper'),
            ...
            i = e.parentElement.querySelector('.slider-navigation__btns-prev'),
            n = e.parentElement.querySelector('.slider-navigation__btns-next');
          new K(e, {
            modules: [J, X],
            slidesPerView: 1,
            loop: !0,
        ...
        (function (t) {
          if (document.querySelectorAll(`.${t.card}`)) {
            const i = document.querySelectorAll(`.${t.card}`);
            window.innerWidth >= e
              ? ee(i, t.slider, t.slide, t.card, t.counts[0])
              : window.innerWidth < e && window.innerWidth >= 768
                ? ee(i, t.slider, t.slide, t.card, t.counts[1])
                : window.innerWidth < 768 && ee(i, t.slider, t.slide, t.card, t.counts[2]);
          }
        })(te.news),
        (function () {
          if (document.querySelector('.news__swiper')) {
            const e = document.querySelector('.news__swiper'),
              t = e.parentElement.querySelector('.slider-navigation__btns-prev'),
            ...
            new K(e, {
              ...
              breakpoints: {
                300: { slidesPerView: 1.06, spaceBetween: 13 },
        ...
        e &&
          e.forEach((e) => {
            const t = e.querySelector('.js-dropdown-inner'),
              i = e.querySelector('.js-dropdown-value'),
              n = e.querySelectorAll('.js-dropdown-item label');
            t.addEventListener('click', () => {
              e.classList.contains('--active') ? e.classList.remove('--active') : e.classList.add('--active');
            });
            for (let t = 0; t < n.length; t += 1)
              n[t].addEventListener('click', (t) => {
                i && ((i.textContent = t.target.textContent), e.classList.add('--filled')),
      ...
      document.addEventListener('DOMContentLoaded', () => {
        !(function () {
            ...
            e.forEach((e) => {
              ...
              e.forEach((e) => {
                const t = e.querySelector('input'),
                  i = e.querySelector('.input__input');
                i &&
                  (i.addEventListener('click', () => t.focus()),
          ...
          document.querySelector('.input--password') &&
            document.querySelectorAll('.input--password').forEach((e) => {
          ...
          (function () {
            const e = document.querySelectorAll('input[type="email"]');
            e &&
              e.forEach((e) => {
                Inputmask('email').mask(e);
              });
          })();
      });
    class ne {
      ...
      open() {
        this.modal.classList.remove('success', 'error'),
          ...
          (document.body.style.width = document.body.clientWidth - ie() + 'px'),
      ...
      changeModalContent(e) {
        if (e.modal.querySelector('.--main') && e.modal.querySelector('.--success')) {
          const t = e.modal.querySelector('.--main'),
            i = e.modal.querySelector('.--success');
          (t.style = ''), (i.style.display = 'none');
        }
      }
      close() {
    ...
    document.querySelector('[data-modal="write-request"]') && new ne('write-request'),
      document.querySelector('[data-modal="account-create-success"]') && new ne('account-create-success'),
      document.querySelector('[data-modal="email-confirmed"]') && new ne('email-confirmed'),
      document.querySelector('[data-modal="request-sent"]') && new ne('request-sent'),
      document.querySelector('[data-modal="exit-confirmation"]') && new ne('exit-confirmation'),
      (function () {
        const e = document.querySelector('.modal-write'),
          i = document.querySelector('.modal-write.--success');
        document.querySelector('.modal-write__btns .btn-def').addEventListener('click', () => {
          var n;
          ((n = e).style.opacity = 1),
            (n.style.transition = 'opacity 0ms'),
            (n.style.opacity = 0),
            setTimeout(() => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      window.location.href.includes('main') &&
        (window.pageYOffset >= 6 && ae.classList.remove('header--transparent'),
        (window.onscroll = () => {
          window.pageYOffset > 6 ? ae.classList.remove('header--transparent') : ae.classList.add('header--transparent');
        }));
    }),
      document.addEventListener('DOMContentLoaded', () => {
        document.querySelectorAll('[data-content-btn]').forEach((e) => {
          e.addEventListener('click', (e) => {
            const t = e.currentTarget.getAttribute('data-content-btn'),
              i = document.querySelectorAll('[data-content-block]'),
              n = document.querySelectorAll(`[data-content-block=${t}]`);
            i.forEach((e) => e.classList.remove('--active')),
              n.forEach((e) => e.classList.add('--active')),
              document.querySelector('.tooltip') && document.querySelector('.tooltip').remove();
          });
        }),
          document.querySelectorAll('[data-subcontent-btn]').forEach((e) => {
            e.addEventListener('click', (e) => {
              const t = e.currentTarget.getAttribute('data-subcontent-btn'),
                i = document.querySelectorAll('[data-subcontent-block]'),
                n = document.querySelectorAll(`[data-subcontent-block=${t}]`);
              i.forEach((e) => e.classList.remove('--active')),
                n.forEach((e) => e.classList.add('--active')),
                (function () {
                  if (document.querySelector('.reg__content-fieldset')) {
                    const e = document.querySelectorAll('.reg__content-fieldset'),
                      t = document.querySelectorAll('.reg__form-numbers__block');
                    e.forEach((e, i) => {
      ...
      document.addEventListener('DOMContentLoaded', function () {
        if (document.querySelectorAll('.account__table-btn')) {
          let t;
          document.querySelectorAll('.account__table-btn').forEach((i) => {
            i.addEventListener('mouseover', (i) => {
              const n = i.currentTarget,
                a = n.dataset.tooltip;
              if (!a || '' === n.getAttribute('disabled')) return;
              (t = document.createElement('div')), (t.className = 'tooltip');
              const r = `\n          <span>${a}</span>\n        `;
              (t.innerHTML = r), document.body.append(t);
              const s = n.getBoundingClientRect();
              let o, l;
              window.innerWidth < e
                ? ((l = s.left + (n.offsetWidth - t.offsetWidth) / 2 - 108),
                  l < 0 && (l = 108),
                  (o = s.top - t.offsetHeight - -34),
                  o < 0 && (o = s.top + n.offsetHeight + -34))
                : ((l = s.left + (n.offsetWidth - t.offsetWidth) / 2),
                  l < 0 && (l = 5),
                  (o = s.top - t.offsetHeight - 8),
                  o < 0 && (o = s.top + n.offsetHeight + 8)),
                (t.style.left = `${l}px`),
                (t.style.top = `${o}px`);
            }),
    ...
    const re = document.querySelectorAll('.chat__menu-item'),
      se = document.querySelector('.chat__left'),
      oe = document.querySelector('.chat__content'),
      le = document.querySelector('.chat__content-button');
    let ce;
    ...
    function de() {
      const e = document.querySelector('.chat__content-new').offsetTop;
      ce.getScrollElement().scrollTo({ top: e });
    }
    document.addEventListener('DOMContentLoaded', () => {
        ...
        (window.outerWidth < e &&
          le.addEventListener('click', () => {
            se.classList.remove('--hide'),
              ...
              re.forEach((e) => e.classList.remove('--active'));
          }),
        re.forEach((t) => {
          t.addEventListener('click', () => {
            re.forEach((e) => e.classList.remove('--active')),
              t.classList.add('--active'),
              window.outerWidth < e && (se.classList.add('--hide'), oe.classList.add('--active')),
              de();
          });
        }),
        window.outerWidth < e && re.forEach((e) => e.classList.remove('--active')),
        de());
    }),
      (function (e) {
        const t = new Image();
